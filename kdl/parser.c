...
static TSCharacterRange sym__normal_bare_identifier_character_set_2[] = {
  ...
  {0xcf1, 0xcf2}, {0xd00, 0xd0c}, {0xd0e, 0xd10}, {0xd12, 0xd44}, {0xd46, 0xd48}, {0xd4a, 0xd4e}, {0xd54, 0xd63}, {0xd66, 0xd78},
  ...
  {0xec8, 0xecd}, {0xed0, 0xed9}, {0xedc, 0xedf}, {0xf00, 0xf00}, {0xf18, 0xf19}, {0xf20, 0xf33}, {0xf35, 0xf35}, {0xf37, 0xf37},
  ...
  {0x10879, 0x1089e}, {0x108a7, 0x108af}, {0x108e0, 0x108f2}, {0x108f4, 0x108f5}, {0x108fb, 0x1091b}, {0x10920, 0x1092b}, {0x1f004, 0x1f004}, {0x1f0cf, 0x1f0cf},
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == 0xa9 ||
          ...
          (0x1f6dd <= lookahead && lookahead <= 0x1f6e5) ||
          lookahead == 0x1f6e9 ||
          lookahead == 0x1f6eb ||
          lookahead == 0x1f6ec ||
          lookahead == 0x1f6f0 ||
          ...
          (0x1fa70 <= lookahead && lookahead <= 0x1fa74) ||
          (0x1fa78 <= lookahead && lookahead <= 0x1fa7c) ||
          (0x1fa80 <= lookahead && lookahead <= 0x1fa86) ||
          (0x1fa90 <= lookahead && lookahead <= 0x1faac) ||
          (0x1fab0 <= lookahead && lookahead <= 0x1faba) ||
          (0x1fac0 <= lookahead && lookahead <= 0x1fac5) ||
          (0x1fad0 <= lookahead && lookahead <= 0x1fad9) ||
          (0x1fae0 <= lookahead && lookahead <= 0x1fae7) ||
          (0x1faf0 <= lookahead && lookahead <= 0x1faf6)) ADVANCE(25);
      if (set_contains(sym___identifier_char_no_digit_sign_character_set_1, 500, lookahead)) ADVANCE(25);
    ...
    case 1:
      ...
      if (set_contains(sym___identifier_char_no_digit_character_set_1, 500, lookahead)) ADVANCE(27);
      END_STATE();
    case 2:
      ADVANCE_MAP(
        '\n', 56,
      ...
      if (lookahead == '\t' ||
          ...
          lookahead == 0x205f ||
          lookahead == 0x3000) ADVANCE(63);
      if (set_contains(sym__identifier_char_character_set_1, 500, lookahead)) ADVANCE(26);
      END_STATE();
    case 3:
      ADVANCE_MAP(
        '\n', 56,
    ...
    case 19:
      ...
      if (lookahead == '\t' ||
          ...
          lookahead == 0x205f ||
          lookahead == 0x3000) ADVANCE(63);
      if (set_contains(sym__normal_bare_identifier_character_set_2, 645, lookahead)) ADVANCE(25);
      END_STATE();
    case 20:
