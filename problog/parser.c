...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      END_STATE();
    case 1:
      if (!eof && (lookahead == 0)) ADVANCE(143);
      if (lookahead == '\n') ADVANCE(142);
    ...
    case 82:
      ...
      END_STATE();
    case 83:
      if (sym_double_quoted_list_notation_character_set_1(lookahead)) ADVANCE(88);
    ...
    case 86:
      ...
      END_STATE();
    case 87:
      if (sym_double_quoted_list_notation_character_set_2(lookahead)) ADVANCE(87);
      if (lookahead == '"') ADVANCE(126);
      if (lookahead == '#') ADVANCE(3);
      if (lookahead == '\\') ADVANCE(82);
      END_STATE();
    case 88:
      if (aux_sym_atom_token1_character_set_1(lookahead)) ADVANCE(88);
    ...
    case 99:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ...
          ('e' <= lookahead && lookahead <= 'z')) ADVANCE(103);
    ...
    case 101:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ...
          ('n' <= lookahead && lookahead <= 'z')) ADVANCE(103);
    ...
    case 102:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ...
          ('p' <= lookahead && lookahead <= 'z')) ADVANCE(103);
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [36] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(26),
  [39] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(60),
  ...
  [51] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(57),
