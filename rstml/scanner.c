...
static inline void advance_rstml(TSLexer *lexer) { lexer->advance_rstml(lexer, false); }

static inline void skip_rstml(TSLexer *lexer) { lexer->advance_rstml(lexer, true); }
