...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [320] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_additional_step_keyword, 1),
...
TS_PUBLIC const TSLanguage *tree_sitter_gherkin() {
