...
enum ts_symbol_identifiers {
  ...
  sym__words = 34,
  sym_arrow = 35,
  aux_sym_root_repeat1 = 36,
  aux_sym_family_repeat1 = 37,
  aux_sym_relations_repeat1 = 38,
  aux_sym_sources_repeat1 = 39,
  aux_sym_targets_repeat1 = 40,
  aux_sym_name_aliases_repeat1 = 41,
  anon_alias_sym__words = 42,
  alias_sym_surname = 43,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [14] = {.entry = {.count = 1, .reusable = true}}, SHIFT(49),
  [16] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [18] = {.entry = {.count = 1, .reusable = false}}, SHIFT(19),
  [20] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [22] = {.entry = {.count = 1, .reusable = false}}, SHIFT(4),
  [24] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 3, 0, 6),
  [26] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 3, 0, 6),
  [28] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 3, 0, 9),
  [30] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_relation, 3, 0, 9), SHIFT(5),
  [33] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 4, 0, 9),
  [35] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 4, 0, 9),
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arrow, 1, 0, 0),
  [39] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_arrow, 1, 0, 0),
  [41] = {.entry = {.count = 1, .reusable = true}}, SHIFT(40),
  [43] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [45] = {.entry = {.count = 1, .reusable = true}}, SHIFT(23),
  [47] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sources, 1, 0, 0),
  [49] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sources, 1, 0, 0),
  [51] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unknown, 1, 0, 0),
  [53] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unknown, 1, 0, 0),
  [55] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 8), SHIFT_REPEAT(40),
  [58] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 8), SHIFT_REPEAT(23),
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 8),
  [63] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 8),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sources, 2, 0, 5),
  [67] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sources, 2, 0, 5),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 7),
  [71] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 7),
  ...
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_def, 1, 0, 1),
  [81] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_def, 1, 0, 1),
  [83] = {.entry = {.count = 1, .reusable = true}}, SHIFT(79),
  [85] = {.entry = {.count = 1, .reusable = true}}, SHIFT(39),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_def, 2, 0, 12),
  [89] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_def, 2, 0, 12),
  [91] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__words, 1, 0, 4),
  [95] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__words, 1, 0, 4),
  [97] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_targets, 1, 0, 0),
  [99] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_targets, 1, 0, 0), SHIFT(6),
  [102] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_targets, 2, 0, 5),
  [106] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_targets, 2, 0, 5), SHIFT(6),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 8),
  [111] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 8), SHIFT_REPEAT(6),
  [114] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 8), SHIFT_REPEAT(6),
  [117] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 8), SHIFT_REPEAT(23),
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_aliases, 4, 0, 0),
  [122] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_aliases, 4, 0, 0),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_aliases, 2, 0, 0),
  [126] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_aliases, 2, 0, 0),
  [128] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [130] = {.entry = {.count = 1, .reusable = true}}, SHIFT(7),
  [132] = {.entry = {.count = 1, .reusable = false}}, SHIFT(7),
  [134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_aliases, 3, 0, 0),
  [136] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_aliases, 3, 0, 0),
  ...
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_def, 3, 0, 16),
  [146] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_def, 3, 0, 16),
  [148] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 1, 0, 0),
  [152] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comment, 1, 0, 0),
  [154] = {.entry = {.count = 1, .reusable = false}}, SHIFT(36),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_def, 3, 0, 15),
  [158] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_def, 3, 0, 15),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_def, 4, 0, 19),
  [162] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_def, 4, 0, 19),
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 2, 0, 0),
  [166] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comment, 2, 0, 0),
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family_name, 1, 0, 1),
  [170] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family_name, 1, 0, 1),
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_num_unknown, 2, 0, 12),
  [174] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_num_unknown, 2, 0, 12),
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_def, 2, 0, 13),
  [178] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_def, 2, 0, 13),
  [180] = {.entry = {.count = 1, .reusable = false}}, SHIFT(14),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_def, 3, 0, 17),
  [184] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_def, 3, 0, 17),
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 7),
  [188] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 7),
  [190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 3, 0, 1),
  [192] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_family, 3, 0, 1), SHIFT(17),
  [195] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_family, 3, 0, 1), SHIFT(60),
  [198] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 4, 0, 1),
  [200] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_family, 4, 0, 1), SHIFT(20),
  [203] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_family, 4, 0, 1), SHIFT(60),
  [206] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 3, 0, 0),
  [208] = {.entry = {.count = 1, .reusable = true}}, SHIFT(57),
  [210] = {.entry = {.count = 1, .reusable = false}}, SHIFT(80),
  [212] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 2, 0, 0),
  [214] = {.entry = {.count = 1, .reusable = true}}, SHIFT(58),
  [216] = {.entry = {.count = 1, .reusable = false}}, SHIFT(84),
  [218] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0),
  [220] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0), SHIFT_REPEAT(22),
  [223] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0),
  [227] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0), SHIFT_REPEAT(72),
  [230] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0),
  [232] = {.entry = {.count = 1, .reusable = false}}, SHIFT(21),
  [234] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 1, 0, 0),
  [236] = {.entry = {.count = 1, .reusable = true}}, SHIFT(59),
  [238] = {.entry = {.count = 1, .reusable = false}}, SHIFT(83),
  [240] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relations, 1, 0, 0),
  [242] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_relations, 1, 0, 0), SHIFT(22),
  [245] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relations, 1, 0, 0),
  [247] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_family_repeat1, 2, 0, 0),
  [249] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_family_repeat1, 2, 0, 0), SHIFT_REPEAT(60),
  [252] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relations, 2, 0, 0),
  [254] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_relations, 2, 0, 0), SHIFT(22),
  [257] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relations, 2, 0, 0),
  [259] = {.entry = {.count = 1, .reusable = true}}, SHIFT(55),
  [261] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 4, 0, 0),
  [263] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_family_repeat1, 2, 0, 0),
  [265] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_name_aliases_repeat1, 2, 0, 0), SHIFT_REPEAT(82),
  [268] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_name_aliases_repeat1, 2, 0, 0),
  [270] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 4, 0, 11),
  [272] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 4, 0, 11),
  [274] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 1, 0, 1),
  [276] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_family, 1, 0, 1), SHIFT(16),
  [279] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_family, 1, 0, 1), SHIFT(56),
  [282] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 3, 0, 10),
  [284] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 3, 0, 10),
  [286] = {.entry = {.count = 1, .reusable = true}}, SHIFT(82),
  [288] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [290] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 4, 0, 14),
  [292] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 4, 0, 14),
  [294] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family, 3, 0, 1),
  [296] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 6, 0, 1),
  [298] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family, 6, 0, 1),
  [300] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 5, 0, 1),
  [302] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family, 5, 0, 1),
  [304] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 5, 0, 18),
  [306] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 5, 0, 18),
  [308] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family_name, 2, 0, 2),
  [310] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family_name, 2, 0, 2),
