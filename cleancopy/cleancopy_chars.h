...
const int32_t UNICHR_SPACE_CHAR[] = {
    ...
    0x205F,
    0x3000,};
const int32_t UNICHR_TAB_CHAR[] = {'\t'};
const int32_t UNICHR_NEWLINE = 0x000A;
const int32_t UNICHR_CR = 0x000D;
const int32_t UNICHR_ZWSP = 0x200B;
const int32_t UNICHR_ZWNBSP = 0xFEFF;
const int32_t UNICHR_NODEDEF_SYMBOL = 0x003E;
const int32_t UNICHR_EMPTY_NODE_SYMBOL = 0x003C;

const int32_t UNICHR_EMBED_MAGIC[] = {
    '_', '_', 'e', 'm', 'b', 'e', 'd', '_', '_'};
...
static inline bool within_unichr_ranges(
        ...
        character range efficiently. It relies upon the sorted nature of the
        character ranges, and then does a binary search for the individual
