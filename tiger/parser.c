...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 2:
      ...
      if (set_contains(sym_escape_sequence_character_set_1, 10, lookahead)) ADVANCE(17);
      END_STATE();
    case 3:
      if (lookahead == '\t' ||
          lookahead == '\n' ||
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_sequence_expression] = STATE(116),
    [sym_array_expression] = STATE(116),
    [sym_record_expression] = STATE(116),
    ...
    [sym_meta_cast] = STATE(116),
    [sym_meta_expression] = STATE(116),
    [sym_meta_lvalue] = STATE(44),
    [sym_meta_type_identifier] = STATE(202),
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(104)] = 5663,
  [SMALL_STATE(105)] = 5700,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [135] = {.entry = {.count = 1, .reusable = false}}, SHIFT(108),
  [137] = {.entry = {.count = 1, .reusable = false}}, SHIFT(115),
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__lvalue, 1, 0, 0),
  [141] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__lvalue, 1, 0, 0), SHIFT(25),
  [144] = {.entry = {.count = 1, .reusable = true}}, SHIFT(3),
  [146] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__lvalue, 1, 0, 0),
  [148] = {.entry = {.count = 1, .reusable = true}}, SHIFT(208),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_value, 3, 0, 9),
  [152] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [154] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record_value, 3, 0, 9),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expr, 1, 0, 0),
  ...
  [166] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array_value, 4, 0, 24),
  [168] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_array_value, 4, 0, 24),
  [170] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_meta_lvalue, 4, 0, 23),
  [172] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_meta_lvalue, 4, 0, 23),
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_meta_type_identifier, 4, 0, 0),
  [176] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_meta_type_identifier, 4, 0, 0),
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_expression, 3, 0, 0),
  [180] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_let_expression, 3, 0, 0),
  ...
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 3, 0, 8),
  [188] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [190] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expression, 3, 0, 8),
  ...
  [200] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sequence_expression, 2, 0, 0),
  [202] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sequence_expression, 2, 0, 0),
  [204] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment_expression, 3, 0, 10),
  [206] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [208] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_expression, 3, 0, 11),
  [210] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record_expression, 3, 0, 11),
  [212] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_call, 4, 0, 12),
  [214] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_call, 4, 0, 12),
  [216] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_expression, 2, 0, 1),
  [218] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sequence_expression, 4, 0, 0),
  [220] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sequence_expression, 4, 0, 0),
  [222] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_expression, 4, 0, 13),
  [224] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [226] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_while_expression, 4, 0, 14),
  [228] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_expression, 4, 0, 15),
  [230] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_let_expression, 4, 0, 15),
  [232] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_expression, 4, 0, 16),
  [234] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_let_expression, 4, 0, 16),
  [236] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_meta_expression, 4, 0, 23),
  [238] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_meta_expression, 4, 0, 23),
  [240] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_call, 5, 0, 25),
  [242] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_call, 5, 0, 25),
  [244] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_expression, 5, 0, 26),
  [246] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_let_expression, 5, 0, 26),
  [248] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_expression, 5, 0, 27),
  [250] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_let_expression, 5, 0, 27),
  ...
  [256] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_call, 5, 0, 32),
  [258] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_method_call, 5, 0, 32),
  [260] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_call, 3, 0, 5),
  [262] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_call, 3, 0, 5),
  [264] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array_expression, 6, 0, 33),
  [266] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_expression, 6, 0, 34),
  [268] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record_expression, 6, 0, 34),
  [270] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_expression, 6, 0, 35),
  [272] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_expression, 6, 0, 36),
  [274] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_let_expression, 6, 0, 36),
  [276] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_expression, 3, 0, 6),
  [278] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record_expression, 3, 0, 6),
  [280] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_meta_cast, 6, 0, 42),
  [282] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_meta_cast, 6, 0, 42),
  [284] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_call, 6, 0, 43),
  [286] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_method_call, 6, 0, 43),
  [288] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array_expression, 6, 0, 44),
  [290] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_expression, 6, 0, 45),
  [292] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record_expression, 6, 0, 45),
  [294] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_expression, 7, 0, 46),
  [296] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record_expression, 7, 0, 46),
  [298] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sequence_expression, 3, 0, 0),
  [300] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sequence_expression, 3, 0, 0),
  [302] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_call, 7, 0, 53),
  [304] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_method_call, 7, 0, 53),
  [306] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_expression, 7, 0, 54),
  [308] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record_expression, 7, 0, 54),
  [310] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_new_expression, 2, 0, 3),
  [312] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_new_expression, 2, 0, 3),
  [314] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_for_expression, 8, 0, 55),
  [316] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_new_expression, 2, 0, 4),
  [318] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_new_expression, 2, 0, 4),
  [320] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_declaration, 6, 0, 39),
  [322] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_declaration, 6, 0, 40),
  [324] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_declaration, 4, 0, 18),
  [326] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_declaration, 5, 0, 28),
  [328] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_declaration, 7, 0, 52),
  [330] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_declaration, 7, 0, 51),
  [332] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__declaration_chunks, 2, 0, 0),
  [334] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declaration_chunks, 2, 0, 0), SHIFT_REPEAT(216),
  [337] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declaration_chunks, 2, 0, 0), SHIFT_REPEAT(232),
  [340] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declaration_chunks, 2, 0, 0), SHIFT_REPEAT(256),
  [343] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declaration_chunks, 2, 0, 0), SHIFT_REPEAT(235),
  [346] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declaration_chunks, 2, 0, 0), SHIFT_REPEAT(210),
  [349] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declaration_chunks, 2, 0, 0), SHIFT_REPEAT(262),
  [352] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declaration_chunks, 2, 0, 0), SHIFT_REPEAT(236),
  ...
  [395] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sequence_expression_repeat1, 2, 0, 0),
  [397] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_declaration, 5, 0, 28),
  [399] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_declaration, 7, 0, 51),
  [401] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_declaration, 7, 0, 52),
  [403] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_record_expression_repeat1, 4, 0, 62),
  [405] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_function_call_repeat1, 2, 0, 0),
  ...
  [423] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__declaration_chunk_repeat3, 2, 0, 0),
  [425] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declaration_chunk_repeat3, 2, 0, 0), SHIFT_REPEAT(232),
  [428] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declaration_chunk_repeat3, 2, 0, 0), SHIFT_REPEAT(256),
  ...
  [439] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 5, 0, 49),
  [441] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__declaration_chunk_repeat1, 2, 0, 0),
  [443] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declaration_chunk_repeat1, 2, 0, 0), SHIFT_REPEAT(216),
  [446] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 5, 0, 50),
  [448] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 6, 0, 61),
  [450] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 2, 0, 0),
  [452] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__declaration_chunk_repeat2, 2, 0, 0),
  [454] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declaration_chunk_repeat2, 2, 0, 0), SHIFT_REPEAT(262),
  [457] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 6, 0, 59),
  [459] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_type, 6, 0, 63),
  [461] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_type, 5, 0, 56),
  [463] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_type, 5, 0, 57),
  [465] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_type, 5, 0, 58),
  [467] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_type, 4, 0, 48),
  [469] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_alias, 1, 0, 17),
  [471] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_alias, 1, 0, 0),
  [473] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array_type, 3, 0, 37),
  [475] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_primitive_declaration, 3, 0, 7),
  [477] = {.entry = {.count = 1, .reusable = true}}, SHIFT(191),
  [479] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_type, 6, 0, 64),
  [481] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_type, 4, 0, 0),
  [483] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_type, 2, 0, 0),
  [485] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array_type, 3, 0, 38),
  [487] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_type, 3, 0, 0),
  [489] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_meta_chunks, 4, 0, 23),
  [491] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_primitive_declaration, 5, 0, 29),
  [493] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_declaration, 5, 0, 19),
  [495] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_primitive_declaration, 5, 0, 30),
  [497] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_declaration, 5, 0, 31),
  [499] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_declaration, 6, 0, 41),
  [501] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_declaration, 4, 0, 18),
  [503] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_declaration, 2, 0, 2),
  [505] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_declaration, 4, 0, 19),
  ...
  [515] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__class_declaration_common_repeat1, 2, 0, 0),
  [517] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__class_declaration_common_repeat1, 2, 0, 0), SHIFT_REPEAT(235),
  [520] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__class_declaration_common_repeat1, 2, 0, 0), SHIFT_REPEAT(247),
  ...
  [533] = {.entry = {.count = 1, .reusable = false}}, SHIFT(49),
  ...
  [543] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 2, 0, 0), SHIFT_REPEAT(164),
  [546] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sequence_expression_repeat1, 2, 0, 0), SHIFT_REPEAT(17),
  ...
  [555] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_call_repeat1, 2, 0, 0), SHIFT_REPEAT(22),
  ...
  [576] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_record_expression_repeat1, 2, 0, 47), SHIFT_REPEAT(261),
  [579] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_record_expression_repeat1, 2, 0, 47),
  ...
  [601] = {.entry = {.count = 1, .reusable = false}}, SHIFT(245),
  ...
  [613] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2, 0, 60), SHIFT_REPEAT(215),
  [616] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2, 0, 60),
  [618] = {.entry = {.count = 1, .reusable = false}}, SHIFT(137),
  [620] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__field_declaration, 1, 0, 20),
  [622] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_record_type_repeat1, 2, 0, 60), SHIFT_REPEAT(234),
  [625] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_record_type_repeat1, 2, 0, 60),
  ...
  [637] = {.entry = {.count = 1, .reusable = false}}, SHIFT(168),
  ...
  [665] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 4, 0, 49),
  [667] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 4, 0, 50),
  [669] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_record_type_repeat1, 4, 0, 56),
  [671] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_record_type_repeat1, 4, 0, 57),
  ...
  [749] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_extends_qualifier, 2, 0, 21),
  [751] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_extends_qualifier, 2, 0, 22),
