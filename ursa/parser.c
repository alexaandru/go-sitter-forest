...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 1:
      ...
      if (set_contains(sym_identifier_character_set_1, 648, lookahead)) ADVANCE(190);
      END_STATE();
    case 2:
    ...
    case 79:
      ACCEPT_TOKEN(anon_sym_let);
      if (set_contains(sym_identifier_character_set_2, 756, lookahead)) ADVANCE(190);
      END_STATE();
    case 80:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__sequence, 3, 0, 0),
  [151] = {.entry = {.count = 1, .reusable = false}}, SHIFT(176),
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__sequence, 2, 0, 0),
  ...
  [267] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_property_exp_repeat1, 2, 0, 0),
  [269] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_property_exp_repeat1, 2, 0, 0), SHIFT_REPEAT(244),
  [272] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_property_exp_repeat1, 2, 0, 0),
  [274] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__exp, 1, 0, 0),
  [276] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__exp, 1, 0, 0),
  [278] = {.entry = {.count = 1, .reusable = true}}, SHIFT(43),
  [280] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use, 2, 0, 0),
  [282] = {.entry = {.count = 1, .reusable = true}}, SHIFT(255),
  [284] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_use, 2, 0, 0),
  [286] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 3, 0, 0),
  [288] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 3, 0, 0),
  [290] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use, 3, 0, 0),
  [292] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_use, 3, 0, 0),
  [294] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if, 3, 0, 0),
  [296] = {.entry = {.count = 1, .reusable = true}}, SHIFT(222),
  [298] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if, 3, 0, 0),
  [300] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 2, 0, 0),
  [302] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 2, 0, 0),
  [304] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_property_exp, 3, 0, 1),
  [306] = {.entry = {.count = 1, .reusable = true}}, SHIFT(244),
  [308] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_property_exp, 3, 0, 1),
  [310] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_use_repeat1, 2, 0, 0),
  [312] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_use_repeat1, 2, 0, 0), SHIFT_REPEAT(255),
  [315] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_use_repeat1, 2, 0, 0),
  [317] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_property_exp, 4, 0, 1),
  [319] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_property_exp, 4, 0, 1),
  [321] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if, 5, 0, 0),
  [323] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if, 5, 0, 0),
  ...
  [337] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_map, 5, 0, 0),
  [339] = {.entry = {.count = 1, .reusable = true}}, SHIFT(233),
  [341] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__sequence, 1, 0, 0),
  ...
  [365] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 4, 0, 2),
  [367] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call, 4, 0, 2),
  ...
  [379] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let, 4, 0, 3),
  ...
  [401] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 4, 0, 0),
  [403] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_object, 4, 0, 0),
  [405] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_exp, 3, 0, 0),
  [407] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_exp, 3, 0, 0),
  [409] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 3, 0, 2),
  [411] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call, 3, 0, 2),
  [413] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 3, 0, 0),
  [415] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string, 3, 0, 0),
  [417] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 3, 0, 0),
  [419] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list, 3, 0, 0),
  [421] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_list, 3, 0, 0),
  [423] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__exp, 3, 0, 0),
  [425] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__exp, 3, 0, 0),
  ...
  [435] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_use_repeat1, 2, 0, 0), SHIFT_REPEAT(268),
  [438] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_for, 5, 0, 4),
  [440] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_for, 5, 0, 4),
  [442] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_exp, 2, 0, 0),
  [444] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary_exp, 2, 0, 0),
  [446] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lambda, 4, 0, 0),
  [448] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_lambda, 4, 0, 0),
  [450] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_loop, 2, 0, 0),
  [452] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_loop, 2, 0, 0),
  [454] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fn, 2, 0, 0),
  [456] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__fn, 2, 0, 0),
  [458] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_yield, 2, 0, 0),
  [460] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_launch, 2, 0, 0),
  [462] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_await, 2, 0, 0),
  [464] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_return, 2, 0, 0),
  [466] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_break, 2, 0, 0),
  [468] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list, 5, 0, 0),
  [470] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_list, 5, 0, 0),
  [472] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map, 2, 0, 0),
  [474] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_map, 2, 0, 0),
  [476] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bool, 1, 0, 0),
  [478] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_bool, 1, 0, 0),
  [480] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_property_exp_repeat1, 2, 0, 5),
  [482] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_property_exp_repeat1, 2, 0, 5),
  [484] = {.entry = {.count = 1, .reusable = false}}, SHIFT(45),
  [486] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 5, 0, 2),
  [488] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call, 5, 0, 2),
  [490] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 6, 0, 0),
  [492] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_object, 6, 0, 0),
  [494] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map, 6, 0, 0),
  [496] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_map, 6, 0, 0),
  [498] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lambda, 5, 0, 0),
  [500] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_lambda, 5, 0, 0),
  [502] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 7, 0, 0),
  [504] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_object, 7, 0, 0),
  [506] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map, 7, 0, 0),
  [508] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_map, 7, 0, 0),
  [510] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lambda, 6, 0, 0),
  [512] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_lambda, 6, 0, 0),
  [514] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_property_exp_repeat1, 2, 0, 0), SHIFT_REPEAT(259),
  [517] = {.entry = {.count = 1, .reusable = true}}, SHIFT(236),
  [519] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__sequence_repeat1, 2, 0, 0),
  [521] = {.entry = {.count = 1, .reusable = true}}, SHIFT(241),
  [523] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_list_repeat1, 2, 0, 0),
  ...
  [547] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_object_repeat1, 4, 0, 0),
  [549] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [551] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [553] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_map_repeat1, 4, 0, 0),
  ...
  [561] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__sequence_repeat1, 2, 0, 0), SHIFT_REPEAT(31),
  [564] = {.entry = {.count = 1, .reusable = true}}, SHIFT(11),
  [566] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_list_repeat1, 2, 0, 0), SHIFT_REPEAT(29),
  ...
  [577] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_object_repeat1, 2, 0, 0), SHIFT_REPEAT(249),
  ...
  [586] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0), SHIFT_REPEAT(202),
  ...
  [597] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_lambda_repeat1, 2, 0, 0),
  [599] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_lambda_repeat1, 2, 0, 0), SHIFT_REPEAT(246),
  ...
  [636] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_map_repeat1, 2, 0, 0),
  [638] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_map_repeat1, 2, 0, 0), SHIFT_REPEAT(54),
  ...
  [697] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 2, 0, 0),
