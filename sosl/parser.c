...
enum ts_symbol_identifiers {
  ...
  anon_sym_COLON = 120,
  sym_bound_apex_expression = 121,
  aux_sym_null_literal_token1 = 122,
  sym_string_literal = 123,
  sym_int = 124,
  sym_decimal = 125,
  sym_date = 126,
  sym_date_time = 127,
  sym_currency_literal = 128,
  sym_identifier = 129,
  sym_source_file = 130,
  sym_header_comment = 131,
  sym_formatting_comment = 132,
  sym__query_expression = 133,
  sym_sosl_query_body = 134,
  sym_find_clause = 135,
  sym_in_clause = 136,
  sym_in_type = 137,
  sym_returning_clause = 138,
  sym_sobject_return = 139,
  sym_selected_fields = 140,
  sym__selectable_expression = 141,
  sym_using_clause = 142,
  sym_subquery = 143,
  sym_with_division_expression = 144,
  sym_with_highlight = 145,
  sym_with_metadata_expression = 146,
  sym_with_network_expression = 147,
  sym_with_pricebook_expression = 148,
  sym_with_snippet_expression = 149,
  sym_with_spell_correction_expression = 150,
  sym_sosl_with_type = 151,
  sym_sosl_with_clause = 152,
  sym_soql_query_body = 153,
  sym_count_expression = 154,
  sym_select_clause = 155,
  sym_soql_using_clause = 156,
  sym_using_scope_type = 157,
  sym_type_of_clause = 158,
  sym_when_expression = 159,
  sym_else_expression = 160,
  sym_group_by_clause = 161,
  sym__group_by_expression = 162,
  sym_for_clause = 163,
  sym_for_type = 164,
  sym_having_clause = 165,
  sym_from_clause = 166,
  sym_storage_identifier = 167,
  sym_storage_alias = 168,
  sym_fields_expression = 169,
  sym_fields_type = 170,
  sym_where_clause = 171,
  sym__boolean_expression = 172,
  sym_and_expression = 173,
  sym_or_expression = 174,
  sym_not_expression = 175,
  sym__condition_expression = 176,
  sym_comparison_expression = 177,
  sym__comparison = 178,
  sym__value_comparison = 179,
  sym__set_comparison = 180,
  sym_comparable_list = 181,
  sym_soql_with_clause = 182,
  sym_soql_with_type = 183,
  sym_with_user_id_type = 184,
  sym_with_record_visibility_expression = 185,
  sym_with_record_visibility_param = 186,
  sym_with_data_cat_expression = 187,
  sym_with_data_cat_filter = 188,
  sym_with_data_cat_filter_type = 189,
  sym_limit_clause = 190,
  sym_offset_clause = 191,
  sym_update_clause = 192,
  sym_update_type = 193,
  sym_alias_expression = 194,
  sym_order_by_clause = 195,
  sym_order_expression = 196,
  sym_order_direction = 197,
  sym_order_null_direction = 198,
  sym_geo_location_type = 199,
  sym__value_expression = 200,
  sym_function_expression = 201,
  sym_dotted_identifier = 202,
  sym_field_identifier = 203,
  sym_field_list = 204,
  sym_boolean = 205,
  sym_value_comparison_operator = 206,
  sym_set_comparison_operator = 207,
  sym_date_literal = 208,
  sym_date_literal_with_param = 209,
  sym__function_name = 210,
  sym_null_literal = 211,
  sym__soql_literal = 212,
  aux_sym_sosl_query_body_repeat1 = 213,
  aux_sym_sosl_query_body_repeat2 = 214,
  aux_sym_returning_clause_repeat1 = 215,
  aux_sym_selected_fields_repeat1 = 216,
  aux_sym_type_of_clause_repeat1 = 217,
  aux_sym__group_by_expression_repeat1 = 218,
  aux_sym_for_clause_repeat1 = 219,
  aux_sym_from_clause_repeat1 = 220,
  aux_sym_and_expression_repeat1 = 221,
  aux_sym_or_expression_repeat1 = 222,
  aux_sym_comparable_list_repeat1 = 223,
  aux_sym_with_record_visibility_expression_repeat1 = 224,
  aux_sym_with_data_cat_expression_repeat1 = 225,
  aux_sym_with_data_cat_filter_repeat1 = 226,
  aux_sym_update_clause_repeat1 = 227,
  aux_sym_order_by_clause_repeat1 = 228,
  aux_sym_function_expression_repeat1 = 229,
  aux_sym_dotted_identifier_repeat1 = 230,
  aux_sym_field_list_repeat1 = 231,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (('1' <= lookahead && lookahead <= '4')) ADVANCE(898);
    ...
    case 2:
      ...
      if (('1' <= lookahead && lookahead <= '4')) ADVANCE(896);
