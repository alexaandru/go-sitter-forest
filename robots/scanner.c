...
static inline void advance_robots(TSLexer *lexer) { lexer->advance_robots(lexer, false); }

static inline void skip_robots(TSLexer *lexer) { lexer->advance_robots(lexer, true); }
