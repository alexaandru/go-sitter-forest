...
static inline void advance_html(TSLexer *lexer) { lexer->advance_html(lexer, false); }

static inline void skip_html(TSLexer *lexer) { lexer->advance_html(lexer, true); }

static unsigned serialize_html(Scanner *scanner, char *buffer) {
...
static void deserialize_html(Scanner *scanner, const char *buffer, unsigned length) {
