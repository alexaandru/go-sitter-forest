...
static inline void advance_php_only(TSLexer *lexer) { lexer->advance_php_only(lexer, false); }

static inline void skip_php_only(TSLexer *lexer) { lexer->advance_php_only(lexer, true); }
