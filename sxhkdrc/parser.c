...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [aux_sym_hotkey_repeat1] = STATE(9),
  ...
  [3] = {
    ...
    [anon_sym_mode_switch] = ACTIONS(25),
    [anon_sym_lock] = ACTIONS(25),
    [anon_sym_mod1] = ACTIONS(25),
    [anon_sym_mod2] = ACTIONS(25),
    [anon_sym_mod3] = ACTIONS(25),
    [anon_sym_mod4] = ACTIONS(25),
    [anon_sym_mod5] = ACTIONS(25),
    ...
    [sym_keysym] = ACTIONS(40),
    [sym_range] = ACTIONS(28),
    [sym_comment] = ACTIONS(19),
  },
  [4] = {
  ...
  [5] = {
    ...
    [anon_sym_hyper] = ACTIONS(59),
    [anon_sym_meta] = ACTIONS(59),
    [anon_sym_alt] = ACTIONS(59),
    [anon_sym_control] = ACTIONS(59),
    [anon_sym_ctrl] = ACTIONS(59),
    [anon_sym_shift] = ACTIONS(59),
    [anon_sym_mode_switch] = ACTIONS(59),
    [anon_sym_lock] = ACTIONS(59),
    [anon_sym_mod1] = ACTIONS(59),
    [anon_sym_mod2] = ACTIONS(59),
    [anon_sym_mod3] = ACTIONS(59),
    [anon_sym_mod4] = ACTIONS(59),
    [anon_sym_mod5] = ACTIONS(59),
    ...
    [sym_keysym] = ACTIONS(62),
    [sym_range] = ACTIONS(62),
    [sym_comment] = ACTIONS(3),
  },
  [6] = {
    [aux_sym__hotkey] = STATE(5),
  ...
  [8] = {
    ...
    [anon_sym_BSLASH_LF] = ACTIONS(94),
    [anon_sym_super] = ACTIONS(96),
    [anon_sym_hyper] = ACTIONS(96),
    [anon_sym_meta] = ACTIONS(96),
    [anon_sym_alt] = ACTIONS(96),
    [anon_sym_control] = ACTIONS(96),
    [anon_sym_ctrl] = ACTIONS(96),
    [anon_sym_shift] = ACTIONS(96),
    [anon_sym_mode_switch] = ACTIONS(96),
    [anon_sym_lock] = ACTIONS(96),
    [anon_sym_mod1] = ACTIONS(96),
    [anon_sym_mod2] = ACTIONS(96),
    [anon_sym_mod3] = ACTIONS(96),
    [anon_sym_mod4] = ACTIONS(96),
    [anon_sym_mod5] = ACTIONS(96),
    ...
    [sym_keysym] = ACTIONS(106),
    [sym_range] = ACTIONS(98),
    [sym_comment] = ACTIONS(19),
  },
  [9] = {
  ...
  [10] = {
    ...
    [sym_punctuation] = STATE(10),
    [sym_delimiter] = STATE(10),
    [anon_sym_BSLASH_LF] = ACTIONS(55),
    [anon_sym_super] = ACTIONS(112),
    [anon_sym_hyper] = ACTIONS(112),
    [anon_sym_meta] = ACTIONS(112),
    [anon_sym_alt] = ACTIONS(112),
    [anon_sym_control] = ACTIONS(112),
    [anon_sym_ctrl] = ACTIONS(112),
    [anon_sym_shift] = ACTIONS(112),
    [anon_sym_mode_switch] = ACTIONS(112),
    [anon_sym_lock] = ACTIONS(112),
    [anon_sym_mod1] = ACTIONS(112),
    [anon_sym_mod2] = ACTIONS(112),
    [anon_sym_mod3] = ACTIONS(112),
    [anon_sym_mod4] = ACTIONS(112),
    [anon_sym_mod5] = ACTIONS(112),
    ...
    [sym_keysym] = ACTIONS(127),
    [sym_range] = ACTIONS(115),
    [sym_comment] = ACTIONS(19),
  },
  [11] = {
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__hotkey, 2, 0, 0),
  [57] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__hotkey, 2, 0, 0),
  [59] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__hotkey, 2, 0, 0), SHIFT_REPEAT(11),
  [62] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__hotkey, 2, 0, 0), SHIFT_REPEAT(5),
  [65] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__hotkey, 2, 0, 0), SHIFT_REPEAT(13),
  [68] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__hotkey, 2, 0, 0), SHIFT_REPEAT(14),
  [71] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__hotkey, 2, 0, 0), SHIFT_REPEAT(12),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_hotkey, 2, 0, 0),
  [76] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_hotkey_repeat1, 2, 0, 0), SHIFT_REPEAT(20),
  [79] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_hotkey_repeat1, 2, 0, 0), SHIFT_REPEAT(8),
  [82] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_hotkey_repeat1, 2, 0, 0), SHIFT_REPEAT(16),
  [85] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_hotkey_repeat1, 2, 0, 0), SHIFT_REPEAT(15),
  [88] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_hotkey_repeat1, 2, 0, 0), SHIFT_REPEAT(19),
  [91] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_hotkey_repeat1, 2, 0, 0), SHIFT_REPEAT(8),
  ...
  [112] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__hotkey, 2, 0, 0), SHIFT_REPEAT(20),
  [115] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__hotkey, 2, 0, 0), SHIFT_REPEAT(10),
  [118] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__hotkey, 2, 0, 0), SHIFT_REPEAT(16),
  [121] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__hotkey, 2, 0, 0), SHIFT_REPEAT(15),
  [124] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__hotkey, 2, 0, 0), SHIFT_REPEAT(19),
  [127] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__hotkey, 2, 0, 0), SHIFT_REPEAT(10),
  ...
  [138] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute, 1, 0, 0),
  [140] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_attribute, 1, 0, 0),
  [142] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_punctuation, 1, 0, 0),
  [144] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_punctuation, 1, 0, 0),
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binding, 6, 0, 0),
  [148] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binding, 6, 0, 0),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binding, 5, 0, 0),
  [152] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binding, 5, 0, 0),
  ...
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 1, 0, 0),
  [183] = {.entry = {.count = 1, .reusable = true}}, SHIFT(17),
  [185] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [187] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 2, 0, 0),
};
