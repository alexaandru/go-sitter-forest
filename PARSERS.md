...
- [x] [awk](https://github.com/Beaglefoot/tree-sitter-awk) (maintained by @Beaglefoot)
...
- [x] [embedded_template](https://github.com/tree-sitter/tree-sitter-embedded-template) (maintained by @maxbrunsfeld)
...
- [x] [hack](https://github.com/slackhq/tree-sitter-hack) (maintained by @aosq)
...
- [x] [markdown (basic highlighting)](https://github.com/MDeiml/tree-sitter-markdown) (maintained by @MDeiml)
- [x] [markdown_inline (needed for full highlighting)](https://github.com/MDeiml/tree-sitter-markdown) (maintained by @MDeiml)
...
- [x] [mermaid](https://github.com/monaqa/tree-sitter-mermaid) (maintained by @monaqa)
...
- [x] [nickel](https://github.com/nickel-lang/tree-sitter-nickel) (maintained by @ErinvanderVeen, @yannham)
...
- [x] [org](https://github.com/milisims/tree-sitter-org) (maintained by @milisims)
...
- [x] [Path of Exile item filter](https://github.com/ObserverOfTime/tree-sitter-poe-filter) (maintained by @ObserverOfTime)
