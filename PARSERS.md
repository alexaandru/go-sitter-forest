...
6 pending, 8 skipped regeneration, 38 missing queries
...
- [x] [al](https://github.com/SShadowS/tree-sitter-al) 🗸 (maintained by @SShadowS; ❌TODO: requires latest TreeSitter)
...
- [x] [barq](https://github.com/barqlang/tree-sitter-barq) ✔️ (maintained by @yhyadev)
...
- [x] [phpdoc](https://github.com/claytonrcarter/tree-sitter-phpdoc) ✔️ (maintained by @mikehaertl; ❌Unresolved conflict for symbol sequence: type_specifier  •  ';'  …)
...
- [x] [spicy](https://github.com/bbannier/tree-sitter-spicy) ✔️ (maintained by @bbannier)
...
- [x] [systemverilog](https://github.com/gmlarumbe/tree-sitter-systemverilog) ✔️ (maintained by @gmlarumbe; ❌high memory usage (3.9GB); grammar.js broken)
