# 263 Supported Parsers

4 pending, 73 skipped regeneration
...
- [x] [apex](https://github.com/aheber/tree-sitter-sfapex) (maintained by @aheber; ❌grammar.js has local deps)
- [x] [arduino](https://github.com/ObserverOfTime/tree-sitter-arduino) ✔️  (maintained by @ObserverOfTime)
...
- [x] [bass](https://github.com/vito/tree-sitter-bass) (maintained by @amaanq; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
...
- [x] [bicep](https://github.com/amaanq/tree-sitter-bicep) (maintained by @amaanq; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
- [x] [bitbake](https://github.com/amaanq/tree-sitter-bitbake) (maintained by @amaanq; ❌grammar.js has local deps)
- [x] [blueprint](https://gitlab.com/gabmus/tree-sitter-blueprint) (maintained by @gabmus; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
...
- [x] [cairo](https://github.com/amaanq/tree-sitter-cairo) (maintained by @amaanq; ❌grammar.js has local deps)
- [x] [capnp](https://github.com/amaanq/tree-sitter-capnp) (maintained by @amaanq; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
...
- [x] [commonlisp](https://github.com/tree-sitter-grammars/tree-sitter-commonlisp) (maintained by @theHamsta; ❌grammar.js has external dep that I cannot currently install: tree-sitter-clojure)
- [x] [cooklang](https://github.com/addcninblue/tree-sitter-cooklang) ✔️  (maintained by @addcninblue)
- [x] [corn](https://github.com/jakestanger/tree-sitter-corn) ✔️  (maintained by @jakestanger)
- [x] [cpon](https://github.com/amaanq/tree-sitter-cpon) (maintained by @amaanq; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
...
- [x] [csv](https://github.com/amaanq/tree-sitter-csv) (maintained by @amaanq; ❌grammar.js has local deps)
- [x] [cuda](https://github.com/theHamsta/tree-sitter-cuda) ✔️  (maintained by @theHamsta)
...
- [x] [dart](https://github.com/UserNobody14/tree-sitter-dart) (maintained by @akinsho; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
...
- [x] [dtd](https://github.com/tree-sitter-grammars/tree-sitter-xml) (maintained by @ObserverOfTime; ❌grammar.js has local deps)
...
- [x] [elixir](https://github.com/elixir-lang/tree-sitter-elixir) (maintained by @connorlay; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
...
- [x] [erlang](https://github.com/WhatsApp/tree-sitter-erlang) (maintained by @filmor; ❌grammar.js error: repetition quantifier expects a valid decimal)
...
- [x] [fsh](https://github.com/mgramigna/tree-sitter-fsh) (maintained by @mgramigna; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
- [x] [func](https://github.com/amaanq/tree-sitter-func) (maintained by @amaanq; ❌grammar.js has local deps)
...
- [x] [gitattributes](https://github.com/ObserverOfTime/tree-sitter-gitattributes) ✔️  (maintained by @ObserverOfTime)
...
- [x] [gosum](https://github.com/amaanq/tree-sitter-go-sum) ✔️  (maintained by @amaanq)
- [x] [gotmpl](https://github.com/ngalaiko/tree-sitter-go-template) (maintained by @qvalentin; ❌grammar.js has local deps)
- [x] [gowork](https://github.com/omertuc/tree-sitter-go-work) ✔️  (maintained by @omertuc)
- [x] [gpg](https://github.com/ObserverOfTime/tree-sitter-gpg-config) ✔️  (maintained by @ObserverOfTime)
...
- [x] [gstlaunch](https://github.com/theHamsta/tree-sitter-gstlaunch) ✔️  (maintained by @theHamsta)
- [x] [hack](https://github.com/slackhq/tree-sitter-hack) ✔️  (maintained by @aosq)
- [x] [hare](https://github.com/amaanq/tree-sitter-hare) (maintained by @amaanq; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
- [x] [haskell](https://github.com/tree-sitter/tree-sitter-haskell) (maintained by @mrcjkb; ❌grammar.js has local deps)
- [x] [haskell_persistent](https://github.com/MercuryTechnologies/tree-sitter-haskell-persistent) (maintained by @lykahb; ❌grammar.js has local deps)
- [x] [hcl](https://github.com/MichaHoffmann/tree-sitter-hcl) (maintained by @MichaHoffmann; ❌grammar.js has local deps)
- [x] [heex](https://github.com/connorlay/tree-sitter-heex) ✔️  (maintained by @connorlay)
- [x] [helm](https://github.com/ngalaiko/tree-sitter-go-template) (maintained by @qvalentin; ❌grammar.js has local deps)
- [x] [hjson](https://github.com/winston0410/tree-sitter-hjson) (maintained by @winston0410; ❌grammar.js has local deps)
- [x] [hlsl](https://github.com/theHamsta/tree-sitter-hlsl) ✔️  (maintained by @theHamsta)
- [x] [hlsplaylist](https://github.com/Freed-Wu/tree-sitter-hlsplaylist) ✔️  (maintained by @Freed-Wu)
- [x] [hocon](https://github.com/antosha417/tree-sitter-hocon) (maintained by @antosha417; ❌grammar.js has local deps)
...
- [x] [hyprlang](https://github.com/luckasRanarison/tree-sitter-hyprlang) ✔️  (maintained by @luckasRanarison)
- [x] [ini](https://github.com/justinmk/tree-sitter-ini) ✔️  (maintained by @theHamsta)
- [x] [ispc](https://github.com/fab4100/tree-sitter-ispc) ✔️  (maintained by @fab4100)
...
- [x] [json5](https://github.com/Joakker/tree-sitter-json5) (maintained by @Joakker; ❌grammar.js has local deps)
- [x] [JSON with comments](https://gitlab.com/WhyNotHugo/tree-sitter-jsonc) (maintained by @WhyNotHugo; ❌grammar.js has local deps)
...
- [x] [lalrpop](https://github.com/traxys/tree-sitter-lalrpop) (maintained by @traxys; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
...
- [x] [luadoc](https://github.com/amaanq/tree-sitter-luadoc) ✔️  (maintained by @amaanq)
- [x] [lua patterns](https://github.com/amaanq/tree-sitter-luap) ✔️  (maintained by @amaanq)
- [x] [luau](https://github.com/amaanq/tree-sitter-luau) (maintained by @amaanq; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
...
- [x] [markdown (basic highlighting)](https://github.com/MDeiml/tree-sitter-markdown) (maintained by @MDeiml; ❌grammar.js has local deps)
- [x] [markdown_inline (needed for full highlighting)](https://github.com/MDeiml/tree-sitter-markdown) (maintained by @MDeiml; ❌grammar.js has local deps)
...
- [x] [meson](https://github.com/Decodetalkers/tree-sitter-meson) (maintained by @Decodetalkers; ❌grammar.js has local deps)
- [ ] [mlir](https://github.com/artagnon/tree-sitter-mlir) (maintained by @artagnon; ❌grammar.js has local deps)
...
- [x] [nqc](https://github.com/amaanq/tree-sitter-nqc) ✔️  (maintained by @amaanq)
- [x] [objc](https://github.com/amaanq/tree-sitter-objc) (maintained by @amaanq; ❌grammar.js throws error)
...
- [x] [ocamllex](https://github.com/atom-ocaml/tree-sitter-ocamllex) ✔️  (maintained by @undu)
- [x] [odin](https://github.com/amaanq/tree-sitter-odin) (maintained by @amaanq; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
...
- [x] [pem](https://github.com/ObserverOfTime/tree-sitter-pem) ✔️  (maintained by @ObserverOfTime)
- [x] [perl](https://github.com/tree-sitter-perl/tree-sitter-perl) (maintained by @RabbiVeesh, @LeoNerd; ❌grammar.js has local deps)
- [x] [php](https://github.com/tree-sitter/tree-sitter-php) (maintained by @tk-shirasaka; ❌grammar.js has local deps)
- [x] [php_only](https://github.com/tree-sitter/tree-sitter-php) (maintained by @tk-shirasaka; ❌grammar.js has local deps)
- [x] [phpdoc](https://github.com/claytonrcarter/tree-sitter-phpdoc) (maintained by @mikehaertl; ❌grammar.js throws error)
- [x] [pioasm](https://github.com/leo60228/tree-sitter-pioasm) ✔️  (maintained by @leo60228)
- [x] [po](https://github.com/erasin/tree-sitter-po) (maintained by @amaanq; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
- [x] [pod](https://github.com/tree-sitter-perl/tree-sitter-pod) ✔️  (maintained by @RabbiVeesh, @LeoNerd)
- [x] [Path of Exile item filter](https://github.com/ObserverOfTime/tree-sitter-poe-filter) ✔️  (maintained by @ObserverOfTime)
- [x] [pony](https://github.com/amaanq/tree-sitter-pony) (maintained by @amaanq, @mfelsche; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
- [x] [printf](https://github.com/ObserverOfTime/tree-sitter-printf) ✔️  (maintained by @ObserverOfTime)
...
- [x] [psv](https://github.com/amaanq/tree-sitter-csv) (maintained by @amaanq; ❌grammar.js has local deps)
- [x] [pug](https://github.com/zealot128/tree-sitter-pug) ✔️  (maintained by @zealot128)
- [x] [puppet](https://github.com/amaanq/tree-sitter-puppet) (maintained by @amaanq; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
- [x] [purescript](https://github.com/postsolar/tree-sitter-purescript) (maintained by @postsolar; ❌grammar.js has local deps)
- [x] [PyPA manifest](https://github.com/ObserverOfTime/tree-sitter-pymanifest) ✔️  (maintained by @ObserverOfTime)
...
- [x] [qmldir](https://github.com/Decodetalkers/tree-sitter-qmldir) ✔️  (maintained by @amaanq)
- [x] [qmljs](https://github.com/yuja/tree-sitter-qmljs) ✔️  (maintained by @Decodetalkers)
- [x] [Tree-Sitter Query Language](https://github.com/tree-sitter-grammars/tree-sitter-query) (maintained by @steelsojka; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
- [x] [r](https://github.com/r-lib/tree-sitter-r) (maintained by @echasnovski; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
...
- [x] [rbs](https://github.com/joker1007/tree-sitter-rbs) (maintained by @joker1007; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
- [x] [re2c](https://github.com/amaanq/tree-sitter-re2c) ✔️  (maintained by @amaanq)
- [x] [readline](https://github.com/ribru17/tree-sitter-readline) ✔️  (maintained by @ribru17)
...
- [x] [pip requirements](https://github.com/ObserverOfTime/tree-sitter-requirements) ✔️  (maintained by @ObserverOfTime)
...
- [x] [ron](https://github.com/amaanq/tree-sitter-ron) (maintained by @amaanq; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
...
- [x] [slang](https://github.com/theHamsta/tree-sitter-slang) ✔️  (maintained by @theHamsta)
- [x] [slint](https://github.com/slint-ui/tree-sitter-slint) ✔️  (maintained by @hunger)
- [x] [smali](https://git.sr.ht/~yotam/tree-sitter-smali) (maintained by @amaanq; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
- [x] [smithy](https://github.com/indoorvivants/tree-sitter-smithy) (maintained by @amaanq, @keynmol; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
...
- [x] [soql](https://github.com/aheber/tree-sitter-sfapex) (maintained by @aheber; ❌grammar.js has local deps)
- [x] [sosl](https://github.com/aheber/tree-sitter-sfapex) (maintained by @aheber; ❌grammar.js has local deps)
...
- [x] [ssh_config](https://github.com/ObserverOfTime/tree-sitter-ssh-config) (maintained by @ObserverOfTime; ❌grammar.js has local deps)
...
- [x] [supercollider](https://github.com/madskjeldgaard/tree-sitter-supercollider) (maintained by @madskjeldgaard; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
...
- [x] [tablegen](https://github.com/amaanq/tree-sitter-tablegen) (maintained by @amaanq; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
...
- [x] [thrift](https://github.com/duskmoon314/tree-sitter-thrift) (maintained by @amaanq, @duskmoon314; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
- [x] [tiger](https://github.com/ambroisie/tree-sitter-tiger) ✔️  (maintained by @ambroisie)
- [x] [tlaplus](https://github.com/tlaplus-community/tree-sitter-tlaplus) ✔️  (maintained by @ahelwer, @susliko)
...
- [x] [tsv](https://github.com/amaanq/tree-sitter-csv) (maintained by @amaanq; ❌grammar.js has local deps)
- [x] [tsx](https://github.com/tree-sitter/tree-sitter-typescript) (maintained by @steelsojka; ❌grammar.js has local deps)
- [x] [turtle](https://github.com/BonaBeavis/tree-sitter-turtle) ✔️  (maintained by @BonaBeavis)
- [x] [twig](https://github.com/gbprod/tree-sitter-twig) ✔️  (maintained by @gbprod)
- [x] [typescript](https://github.com/tree-sitter/tree-sitter-typescript) (maintained by @steelsojka; ❌grammar.js has local deps)
...
- [x] [udev](https://github.com/ObserverOfTime/tree-sitter-udev) ✔️  (maintained by @ObserverOfTime)
- [x] [ungrammar](https://github.com/Philipp-M/tree-sitter-ungrammar) ✔️  (maintained by @Philipp-M, @amaanq)
- [ ] [unison](https://github.com/kylegoetz/tree-sitter-unison) (maintained by @tapegram; ❌grammar.js has local deps)
- [x] [usd](https://github.com/ColinKennedy/tree-sitter-usd) (maintained by @ColinKennedy; ❌grammar.js error: repetition quantifier expects a valid decimal: u{[0-9a-fA-F]+})
...
- [x] [vim](https://github.com/neovim/tree-sitter-vim) (maintained by @clason; ❌grammar.js has local deps)
