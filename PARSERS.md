...
The list of all parsers, both added (220) and planned (47).
...
- [x] [phpdoc](https://github.com/claytonrcarter/tree-sitter-phpdoc) (maintained by @mikehaertl)
...
- [x] [poe_filter](https://github.com/ObserverOfTime/tree-sitter-poe-filter) (maintained by @ObserverOfTime)
...
- [x] [pymanifest](https://github.com/ObserverOfTime/tree-sitter-pymanifest) (maintained by @ObserverOfTime)
...
- [x] [requirements](https://github.com/ObserverOfTime/tree-sitter-requirements) (maintained by @ObserverOfTime)
