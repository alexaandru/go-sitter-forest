...
- [x] [tsx](https://github.com/tree-sitter/tree-sitter-typescript) ✔️  (maintained by @steelsojka; high memory usage (13GB))
...
- [x] [typescript](https://github.com/tree-sitter/tree-sitter-typescript) ✔️  (maintained by @steelsojka; high memory usage (13GB))
