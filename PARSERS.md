...
This is the list of all parsers, both implemented (142) and planned (125).
...
- [x] [ebnf](https://github.com/RubixDev/ebnf) (maintained by @RubixDev)
...
- [x] [gdscript](https://github.com/PrestonKnopp/tree-sitter-gdscript) (maintained by @PrestonKnopp)
...
- [x] [glimmer](https://github.com/alexlafroscia/tree-sitter-glimmer) (maintained by @NullVoxPopuli)
- [x] [glsl](https://github.com/theHamsta/tree-sitter-glsl) (maintained by @theHamsta)
- [x] [gn](https://github.com/amaanq/tree-sitter-gn) (maintained by @amaanq)
- [x] [gnuplot](https://github.com/dpezto/tree-sitter-gnuplot) (maintained by @dpezto)
- [x] [go](https://github.com/tree-sitter/tree-sitter-go) (maintained by @theHamsta, @WinWisely268)
- [x] [godot_resource](https://github.com/PrestonKnopp/tree-sitter-godot-resource) (maintained by @pierpo)
...
- [x] [hoon](https://github.com/urbit-pilled/tree-sitter-hoon) (maintained by @urbit-pilled)
- [x] [html](https://github.com/tree-sitter/tree-sitter-html) (maintained by @TravonteD)
- [x] [htmldjango](https://github.com/interdependence/tree-sitter-htmldjango) (maintained by @ObserverOfTime)
...
- [x] [ini](https://github.com/justinmk/tree-sitter-ini) (maintained by @theHamsta)
