...
- [x] [markdown (basic highlighting)](https://github.com/MDeiml/tree-sitter-markdown) ✔️  (maintained by @MDeiml)
- [x] [markdown_inline (needed for full highlighting)](https://github.com/MDeiml/tree-sitter-markdown) ✔️  (maintained by @MDeiml)
