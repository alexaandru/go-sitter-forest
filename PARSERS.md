...
The list of all parsers, both added (171) and planned (96).
...
- [x] [markdown](https://github.com/MDeiml/tree-sitter-markdown) (maintained by @MDeiml)
- [x] [markdown_inline](https://github.com/MDeiml/tree-sitter-markdown) (maintained by @MDeiml)
