...
3 pending, 53 skipped regeneration
...
- [x] [bitbake](https://github.com/amaanq/tree-sitter-bitbake) ✔️  (maintained by @amaanq)
...
- [x] [csv](https://github.com/amaanq/tree-sitter-csv) ✔️  (maintained by @amaanq)
...
- [x] [func](https://github.com/amaanq/tree-sitter-func) ✔️  (maintained by @amaanq)
...
- [x] [hcl](https://github.com/MichaHoffmann/tree-sitter-hcl) ✔️  (maintained by @MichaHoffmann)
...
- [x] [meson](https://github.com/Decodetalkers/tree-sitter-meson) ✔️  (maintained by @Decodetalkers)
...
- [x] [psv](https://github.com/amaanq/tree-sitter-csv) ✔️  (maintained by @amaanq)
...
- [x] [tsv](https://github.com/amaanq/tree-sitter-csv) ✔️  (maintained by @amaanq)
- [x] [tsx](https://github.com/tree-sitter/tree-sitter-typescript) ✔️  (maintained by @steelsojka)
