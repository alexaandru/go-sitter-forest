...
- [x] [apex](https://github.com/aheber/tree-sitter-sfapex) (maintained by @aheber; ❌grammar.js has recursive local deps)
...
- [x] [haskell](https://github.com/tree-sitter/tree-sitter-haskell) (maintained by @mrcjkb; ❌grammar.js has recursive local deps)
- [x] [haskell_persistent](https://github.com/MercuryTechnologies/tree-sitter-haskell-persistent) (maintained by @lykahb; ❌grammar.js has recursive local deps)
...
- [x] [markdown (basic highlighting)](https://github.com/MDeiml/tree-sitter-markdown) (maintained by @MDeiml; ❌grammar.js has recursive local deps)
- [x] [markdown_inline (needed for full highlighting)](https://github.com/MDeiml/tree-sitter-markdown) (maintained by @MDeiml; ❌grammar.js has recursive local deps)
...
- [x] [purescript](https://github.com/postsolar/tree-sitter-purescript) (maintained by @postsolar; ❌grammar.js has recursive local deps)
...
- [x] [soql](https://github.com/aheber/tree-sitter-sfapex) (maintained by @aheber; ❌grammar.js has recursive local deps)
- [x] [sosl](https://github.com/aheber/tree-sitter-sfapex) (maintained by @aheber; ❌grammar.js has recursive local deps)
...
- [ ] [unison](https://github.com/kylegoetz/tree-sitter-unison) (maintained by @tapegram; ❌grammar.js has recursive local deps)
