...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [9] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_text, 1, 0, 5),
  [11] = {.entry = {.count = 1, .reusable = true}}, SHIFT(37),
  [13] = {.entry = {.count = 1, .reusable = true}}, SHIFT(38),
  [15] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_line, 1, 0, 18),
  [17] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_text_repeat2, 2, 0, 24),
  [19] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_text_repeat2, 2, 0, 24), SHIFT_REPEAT(37),
  [22] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_text_repeat2, 2, 0, 24), SHIFT_REPEAT(38),
  [25] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_line, 2, 0, 26),
  [27] = {.entry = {.count = 1, .reusable = false}}, SHIFT(32),
  [29] = {.entry = {.count = 1, .reusable = false}}, SHIFT(17),
  [31] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [33] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_doc, 1, 0, 3),
  [35] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_text, 2, 0, 16),
  ...
  [41] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_entries_repeat1, 2, 0, 12), SHIFT_REPEAT(33),
  [44] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_text_repeat2, 1, 0, 13),
  [46] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__meta, 1, 0, 14),
  [48] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__meta, 1, 0, 15),
  [50] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_text_repeat1, 2, 0, 0),
  [52] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_text_repeat1, 2, 0, 0), SHIFT_REPEAT(17),
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label, 2, 0, 22),
  [57] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag, 2, 0, 23),
  [59] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_text_repeat1, 1, 0, 0),
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entryObject, 2, 0, 9),
  [63] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entryList, 2, 0, 10),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_entryObject_repeat1, 2, 0, 20),
  [69] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_entryObject_repeat1, 2, 0, 20), SHIFT_REPEAT(32),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_entryList_repeat1, 2, 0, 21),
  [74] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_entryList_repeat1, 2, 0, 21), SHIFT_REPEAT(29),
  [77] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_header, 3, 0, 17),
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_header, 3, 0, 17),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_entryObject_repeat1, 1, 0, 6),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_listItem, 2, 0, 19),
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_entryList_repeat1, 1, 0, 7),
  ...
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entryText, 2, 0, 8),
  ...
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_doc, 2, 0, 11),
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_doc, 1, 0, 1),
