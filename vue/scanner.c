...
static inline void advance_vue(TSLexer *lexer) { lexer->advance_vue(lexer, false); }

static inline void skip_vue(TSLexer *lexer) { lexer->advance_vue(lexer, true); }

// #define advance_vue(lexer)                                                                                                 \
//     do {                                                                                                               \
//         printf("advance %c, line: %d\n", lexer->lookahead, __LINE__);                                                  \
//         (lexer->advance)(lexer, false);                                                                                \
//     } while (0)
//
// #define skip_vue(lexer) \
//     do { \
//         printf("skip %c, line: %d\n", lexer->lookahead, __LINE__); \
//         (lexer->advance)(lexer, true); \
//     } while (0)

static unsigned serialize_vue(Scanner *scanner, char *buffer) {
...
static void deserialize_vue(Scanner *scanner, const char *buffer, unsigned length) {
...
static bool scan_vue(Scanner *scanner, TSLexer *lexer, const bool *valid_symbols) {
