...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_exec, 4),
  [106] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_exec, 4),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source, 4),
  [110] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_source, 4),
  [112] = {.entry = {.count = 1, .reusable = true}}, SHIFT(70),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_section_repeat1, 2),
  [116] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_section_repeat1, 2), SHIFT_REPEAT(46),
  [119] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_section_repeat1, 2), SHIFT_REPEAT(56),
  [122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section, 5),
  [124] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section, 5),
  [126] = {.entry = {.count = 1, .reusable = true}}, SHIFT(73),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section, 8, .production_id = 1),
  [130] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section, 8, .production_id = 1),
  ...
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section, 6),
  [146] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section, 6),
  [148] = {.entry = {.count = 1, .reusable = true}}, SHIFT(93),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_keyword, 4),
  [152] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_keyword, 4),
  [154] = {.entry = {.count = 1, .reusable = true}}, SHIFT(92),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section, 7, .production_id = 1),
  [158] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section, 7, .production_id = 1),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 3),
  [162] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_assignment, 3),
  [164] = {.entry = {.count = 1, .reusable = true}}, SHIFT(82),
  [166] = {.entry = {.count = 1, .reusable = true}}, SHIFT(37),
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_color, 1),
  [170] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_color, 1),
  [172] = {.entry = {.count = 1, .reusable = false}}, SHIFT(84),
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_number, 1),
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_gradient_repeat1, 1),
  [178] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_gradient_repeat1, 1),
  [180] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rgb, 4),
  [182] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_rgb, 4),
