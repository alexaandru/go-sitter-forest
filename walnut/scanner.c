...
static inline void advance_walnut(TSLexer *lexer) { lexer->advance_walnut(lexer, false); }

static inline void skip_walnut(TSLexer *lexer) { lexer->advance_walnut(lexer, true); }
