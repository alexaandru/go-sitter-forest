...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [17] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_schema, 3, 0, 1),
  [19] = {.entry = {.count = 1, .reusable = true}}, SHIFT(70),
  [21] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [23] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_schema, 5, 0, 5),
  [25] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_schema, 6, 0, 9),
  [27] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_union, 2, 0, 0),
  [29] = {.entry = {.count = 1, .reusable = true}}, SHIFT(75),
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_schema, 4, 0, 3),
  ...
  [39] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_struct_union_repeat1, 2, 0, 0),
  [41] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_struct_union_repeat1, 2, 0, 0), SHIFT_REPEAT(75),
  [44] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag_name, 2, 0, 2),
  [46] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_schema_repeat2, 2, 0, 0),
  [48] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_schema_repeat2, 2, 0, 0), SHIFT_REPEAT(70),
  [51] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_schema_repeat2, 2, 0, 0), SHIFT_REPEAT(36),
  [54] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_schema, 5, 0, 6),
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_optional, 2, 0, 0),
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map, 4, 0, 0),
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_schema, 6, 0, 8),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_schema, 7, 0, 11),
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_schema, 4, 0, 4),
  ...
  [82] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_doc_comment_repeat1, 2, 0, 0),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_doc_comment_repeat1, 2, 0, 0),
  [86] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_doc_comment_repeat1, 2, 0, 0), SHIFT_REPEAT(34),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_schema_repeat1, 2, 0, 0),
  [91] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_schema_repeat1, 2, 0, 0), SHIFT_REPEAT(28),
  [94] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_doc_comment, 1, 0, 0),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_doc_comment, 1, 0, 0),
  [98] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag, 3, 0, 7),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_definition, 5, 0, 0),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag, 4, 0, 12),
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_definition, 4, 0, 0),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_definition, 6, 0, 0),
  [110] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_enum_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(89),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_enum_definition_repeat1, 2, 0, 0),
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct, 8, 0, 13),
  [117] = {.entry = {.count = 1, .reusable = true}}, SHIFT(84),
  [119] = {.entry = {.count = 1, .reusable = true}}, SHIFT(41),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct, 4, 0, 10),
  [123] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [125] = {.entry = {.count = 1, .reusable = true}}, SHIFT(49),
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct, 5, 0, 10),
  [129] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [131] = {.entry = {.count = 1, .reusable = true}}, SHIFT(64),
  [133] = {.entry = {.count = 1, .reusable = true}}, SHIFT(42),
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct, 5, 0, 13),
  [137] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [139] = {.entry = {.count = 1, .reusable = true}}, SHIFT(58),
  [141] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct, 6, 0, 10),
  [143] = {.entry = {.count = 1, .reusable = true}}, SHIFT(74),
  [145] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_struct_repeat1, 2, 0, 0), SHIFT_REPEAT(37),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_struct_repeat1, 2, 0, 0),
  [150] = {.entry = {.count = 1, .reusable = true}}, SHIFT(68),
  [152] = {.entry = {.count = 1, .reusable = true}}, SHIFT(40),
  [154] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct, 6, 0, 13),
  [156] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct, 7, 0, 10),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct, 7, 0, 13),
  [162] = {.entry = {.count = 1, .reusable = true}}, SHIFT(38),
  [164] = {.entry = {.count = 1, .reusable = true}}, SHIFT(67),
  [166] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_field, 3, 0, 14),
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_field, 4, 0, 15),
