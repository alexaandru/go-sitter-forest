...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [17] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_schema, 5, 0, 5),
  [19] = {.entry = {.count = 1, .reusable = true}}, SHIFT(71),
  [21] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [23] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_schema, 6, 0, 9),
  [25] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_schema, 3, 0, 1),
  ...
  [33] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_struct_union_repeat1, 2, 0, 0),
  [35] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_struct_union_repeat1, 2, 0, 0), SHIFT_REPEAT(80),
  [38] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_schema, 4, 0, 3),
  [40] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [42] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_union, 2, 0, 0),
  [44] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag_name, 2, 0, 2),
  [46] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_optional, 2, 0, 0),
  [48] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_schema, 7, 0, 11),
  [50] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_schema, 4, 0, 4),
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map, 4, 0, 0),
  [54] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 3, 0, 0),
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_schema_repeat2, 2, 0, 0),
  [58] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_schema_repeat2, 2, 0, 0), SHIFT_REPEAT(71),
  [61] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_schema_repeat2, 2, 0, 0), SHIFT_REPEAT(34),
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_schema, 6, 0, 8),
  [66] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_schema, 5, 0, 6),
  ...
  [82] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_doc_comment, 1, 0, 0),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_doc_comment, 1, 0, 0),
  [86] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [88] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_doc_comment_repeat1, 2, 0, 0),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_doc_comment_repeat1, 2, 0, 0),
  [92] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_doc_comment_repeat1, 2, 0, 0), SHIFT_REPEAT(36),
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_schema_repeat1, 2, 0, 0),
  [97] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_schema_repeat1, 2, 0, 0), SHIFT_REPEAT(28),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag, 4, 0, 12),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_definition, 6, 0, 0),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_definition, 5, 0, 0),
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_definition, 4, 0, 0),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag, 3, 0, 7),
  [110] = {.entry = {.count = 1, .reusable = true}}, SHIFT(63),
  [112] = {.entry = {.count = 1, .reusable = true}}, SHIFT(41),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct, 7, 0, 10),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct, 8, 0, 13),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct, 7, 0, 13),
  [120] = {.entry = {.count = 1, .reusable = true}}, SHIFT(78),
  [122] = {.entry = {.count = 1, .reusable = true}}, SHIFT(38),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct, 4, 0, 10),
  [126] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_enum_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(88),
  [129] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_enum_definition_repeat1, 2, 0, 0),
  [131] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [133] = {.entry = {.count = 1, .reusable = true}}, SHIFT(59),
  [135] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct, 6, 0, 13),
  ...
  [147] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_struct_repeat1, 2, 0, 0), SHIFT_REPEAT(35),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_struct_repeat1, 2, 0, 0),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct, 6, 0, 10),
  [154] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct, 5, 0, 10),
  [156] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [158] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [160] = {.entry = {.count = 1, .reusable = true}}, SHIFT(53),
  [162] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct, 5, 0, 13),
  [164] = {.entry = {.count = 1, .reusable = true}}, SHIFT(65),
  [166] = {.entry = {.count = 1, .reusable = true}}, SHIFT(39),
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_field, 3, 0, 14),
  [170] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_field, 4, 0, 15),
