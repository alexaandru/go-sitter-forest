...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [234] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_list_value_repeat1, 2), SHIFT_REPEAT(144),
  ...
  [430] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object_type_definition, 6),
  [432] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_object_type_definition, 6),
  ...
  [450] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scalar_type_extension, 4),
  [452] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_scalar_type_extension, 4),
  [454] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_input_fields_definition, 3),
  [456] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_input_fields_definition, 3),
  [458] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object_type_extension, 6),
  [460] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_object_type_extension, 6),
  [462] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_values_definition, 3),
  [464] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_enum_values_definition, 3),
  [466] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_type_extension, 6),
  [468] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_interface_type_extension, 6),
  [470] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_selection_set, 3),
  [472] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_selection_set, 3),
  [474] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fields_definition, 3),
  [476] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_fields_definition, 3),
  [478] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_type_extension, 5),
  [480] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_enum_type_extension, 5),
  [482] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_definition, 1),
  [484] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_type_definition, 1),
  [486] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_executable_definition, 1),
  [488] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_executable_definition, 1),
  [490] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_extension, 1),
  [492] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_type_extension, 1),
  [494] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_schema_extension, 5),
  [496] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_schema_extension, 5),
  [498] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_system_extension, 1),
  [500] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_type_system_extension, 1),
  [502] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_schema_definition, 6),
  [504] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_schema_definition, 6),
  ...
  [510] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_operation_definition, 2),
  [512] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_operation_definition, 2),
  [514] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_schema_definition, 5),
  [516] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_schema_definition, 5),
  [518] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_type_definition, 6),
  [520] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_interface_type_definition, 6),
  [522] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_system_definition, 1),
  [524] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_type_system_definition, 1),
  [526] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_operation_definition, 3),
  [528] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_operation_definition, 3),
  [530] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scalar_type_definition, 4),
  [532] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_scalar_type_definition, 4),
  [534] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_operation_definition, 4),
  [536] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_operation_definition, 4),
  ...
  [558] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_value, 3),
  [560] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_list_value, 3),
  ...
  [574] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 2),
  [576] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable, 2),
  [578] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_value, 1),
  [580] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_enum_value, 1),
  ...
  [604] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field, 1),
  ...
  [634] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_selection_set_repeat1, 2), SHIFT_REPEAT(150),
  [637] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_selection_set_repeat1, 2), SHIFT_REPEAT(149),
...
TS_PUBLIC const TSLanguage *tree_sitter_graphql() {
