...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [7] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(57),
  [10] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(53),
  ...
  [23] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lib, 5),
  [25] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_argument_8bit, 8),
  [27] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_argument_5bit, 5),
  [29] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_jmp, 6, .production_id = 2),
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lbl, 6, .production_id = 2),
  [33] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_srn, 6, .production_id = 2),
  [35] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sbm, 6, .production_id = 2),
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_blo, 6, .production_id = 2),
  [39] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_token, 1),
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_trm, 5),
  [43] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_jro, 5),
  [45] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_gr8, 5),
  [47] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lss, 5),
  [49] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_eql, 5),
  [51] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_instruction, 1, .production_id = 1),
  [53] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_nop, 5),
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prn, 5),
  [57] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pr1, 5),
  [59] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_red, 5),
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_r3d, 5),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_cnt, 5),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_div, 5),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_p0p, 5),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dpl, 5),
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label, 1),
  [73] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_mrg, 5),
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_add, 5),
  [77] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sub, 5),
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_mul, 5),
...
TS_PUBLIC const TSLanguage *tree_sitter_awatalk() {
