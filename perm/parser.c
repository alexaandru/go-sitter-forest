...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [11] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_conditional_repeat1, 2), SHIFT_REPEAT(2),
  [14] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_rule_conditional_repeat1, 2),
  [16] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_rule_conditional_repeat1, 2), SHIFT_REPEAT(5),
  [19] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_conditional_repeat1, 2), SHIFT_REPEAT(5),
  [22] = {.entry = {.count = 1, .reusable = false}}, SHIFT(2),
  [24] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule_conditional, 2),
  [26] = {.entry = {.count = 1, .reusable = true}}, SHIFT(5),
  [28] = {.entry = {.count = 1, .reusable = false}}, SHIFT(5),
  [30] = {.entry = {.count = 1, .reusable = false}}, SHIFT(3),
  [32] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule_conditional, 1),
  [34] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_conditional_statement, 1),
  [36] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_conditional_statement, 1),
  ...
  [46] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_relation_definition_repeat1, 2),
  [48] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_relation_definition_repeat1, 2), SHIFT_REPEAT(44),
  [51] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_relation_definition_repeat1, 2), SHIFT_REPEAT(7),
  [54] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation_definition, 3, .production_id = 2),
  [56] = {.entry = {.count = 1, .reusable = true}}, SHIFT(44),
  [58] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation_association, 2, .production_id = 3),
  [62] = {.entry = {.count = 1, .reusable = true}}, SHIFT(50),
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation_definition, 4, .production_id = 2),
  [66] = {.entry = {.count = 1, .reusable = true}}, SHIFT(7),
  [68] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation_member, 2, .production_id = 5),
  [70] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation_association, 3, .production_id = 4),
  ...
  [79] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(55),
  ...
  [92] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_rule_definition_repeat1, 2), SHIFT_REPEAT(6),
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_rule_definition_repeat1, 2),
  [97] = {.entry = {.count = 1, .reusable = true}}, SHIFT(42),
  [99] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_entity_definition_repeat1, 2), SHIFT_REPEAT(46),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_entity_definition_repeat1, 2),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_boolean_type, 1),
  [106] = {.entry = {.count = 1, .reusable = true}}, SHIFT(43),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_type, 1),
  [110] = {.entry = {.count = 1, .reusable = true}}, SHIFT(41),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_integer_type, 1),
  [114] = {.entry = {.count = 1, .reusable = true}}, SHIFT(40),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_double_type, 1),
  [118] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_boolean_type, 3),
  [122] = {.entry = {.count = 1, .reusable = true}}, SHIFT(4),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_double_type, 3),
  [126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_integer_type, 3),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_type, 3),
  [130] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule_parameter, 2),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute_type, 1),
  [134] = {.entry = {.count = 1, .reusable = true}}, SHIFT(28),
  [136] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [138] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entity_definition, 5, .production_id = 1),
  ...
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entity_definition, 4, .production_id = 1),
  ...
  [162] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule_definition, 7, .production_id = 1),
  ...
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule_definition, 8, .production_id = 1),
