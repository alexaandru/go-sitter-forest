...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [9] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(14),
  [12] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1, 0, 0),
  [14] = {.entry = {.count = 1, .reusable = false}}, SHIFT(12),
  [16] = {.entry = {.count = 1, .reusable = true}}, SHIFT(25),
  [18] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entry, 12, 0, 0),
  [20] = {.entry = {.count = 1, .reusable = false}}, SHIFT(10),
  [22] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_entry, 12, 0, 0),
  [24] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entry, 13, 0, 0),
  [26] = {.entry = {.count = 1, .reusable = false}}, SHIFT(13),
  [28] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_entry, 13, 0, 0),
  ...
  [38] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entry, 14, 0, 0),
  [40] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_user, 1, 0, 0),
  [42] = {.entry = {.count = 1, .reusable = true}}, SHIFT(7),
  [44] = {.entry = {.count = 1, .reusable = true}},  ACCEPT_INPUT(),
  [46] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [48] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_auth, 1, 0, 0),
  [50] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_uid, 1, 0, 0),
  [52] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [54] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_gid, 1, 0, 0),
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_home, 1, 0, 0),
  [58] = {.entry = {.count = 1, .reusable = true}}, SHIFT(27),
  [60] = {.entry = {.count = 1, .reusable = true}}, SHIFT(11),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_gecos, 1, 0, 0),
