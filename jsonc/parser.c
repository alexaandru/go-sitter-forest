...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [17] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 2),
  ...
  [33] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 2),
  [35] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 2),
  [37] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_content, 1),
  ...
  [51] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_content_repeat1, 2),
  [53] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_content_repeat1, 2), SHIFT_REPEAT(17),
  [56] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_content_repeat1, 2), SHIFT_REPEAT(17),
  ...
  [74] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2), SHIFT_REPEAT(3),
  [77] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2),
  [79] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [81] = {.entry = {.count = 1, .reusable = true}}, SHIFT(15),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pair, 3, .production_id = 1),
...
extern const TSLanguage *tree_sitter_jsonc(void) {
