...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [199] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__struct_body_repeat1, 2), SHIFT_REPEAT(66),
  [202] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__struct_body_repeat1, 2),
