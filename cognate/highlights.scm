...
((identifier) @function.builtin (#any-of? @function.builtin "Print" "Prints"
                                 ...
                                 "Ln" "Log" "Triplet" "Head" "Tail" "First"
                                 "Rest" "Sin" "Cos" "Tan" "Asin" "Acos" "Atan"
                                 "Sind" "Cosd" "Tand" "Asind" "Acosd" "Atand"
                                 "Sinh" "Cosh" "Tanh" "Sinhd" "Coshd" "Tanhd"
                                 "Filter" "Number?" "Zero?" "Empty?" "Empty"
                                 "Any?" "None" "All" "Sort" "Append" "Prepend"
                                 "Min" "Max" "Times" "Integer!" "Number!"
                                 "Boolean!" "Block!" "Zero!" "String!"
                                 "List!"))
