...
static void advance_typescript(TSLexer *lexer) { lexer->advance_typescript(lexer, false); }

static void skip_typescript(TSLexer *lexer) { lexer->advance_typescript(lexer, true); }
