...
static inline void advance_razor(TSLexer *lexer) { lexer->advance_razor(lexer, false); }

static inline void skip_razor(TSLexer *lexer) { lexer->advance_razor(lexer, true); }
