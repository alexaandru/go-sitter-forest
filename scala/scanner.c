...
static inline void advance_scala(TSLexer *lexer) { lexer->advance_scala(lexer, false); }

static inline void skip_scala(TSLexer *lexer) { lexer->advance_scala(lexer, true); }
