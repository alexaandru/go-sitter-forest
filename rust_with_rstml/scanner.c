...
static inline void advance_rust_with_rstml(TSLexer *lexer) { lexer->advance_rust_with_rstml(lexer, false); }

static inline void skip_rust_with_rstml(TSLexer *lexer) { lexer->advance_rust_with_rstml(lexer, true); }
