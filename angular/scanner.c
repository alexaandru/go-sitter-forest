...
static inline void advance_angular(TSLexer *lexer) { lexer->advance_angular(lexer, false); }

static inline void skip_angular(TSLexer *lexer) { lexer->advance_angular(lexer, true); }
