  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == '$' ||
          ...
          (57344 <= lookahead && lookahead <= 65535)) ADVANCE(717);
      END_STATE();
    case 1:
      if (lookahead == '\n') ADVANCE(671);
      if (lookahead == '\r') ADVANCE(671);
    ...
    case 2:
      ...
      if (lookahead == '$' ||
          ...
          ('a' <= lookahead && lookahead <= 'z') ||
          (161 <= lookahead && lookahead <= 55295) ||
          (57344 <= lookahead && lookahead <= 65535)) ADVANCE(718);
      if (lookahead != 0 &&
          lookahead != '=') ADVANCE(721);
      END_STATE();
    case 3:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [97] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_request_repeat2, 2), SHIFT_REPEAT(222),
  [100] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_request_repeat2, 2),
  [102] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_request_repeat2, 2), SHIFT_REPEAT(234),
  [105] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_request_repeat2, 2), SHIFT_REPEAT(179),
  [108] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_request_repeat2, 2), SHIFT_REPEAT(178),
  [111] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_request_repeat2, 2), SHIFT_REPEAT(172),
  ...
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_form_data, 3, .production_id = 16),
  [122] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_form_data, 3, .production_id = 16),
  [124] = {.entry = {.count = 1, .reusable = true}}, SHIFT(215),
  [126] = {.entry = {.count = 1, .reusable = false}}, SHIFT(157),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_form_data_repeat2, 2, .production_id = 22),
  [130] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_form_data_repeat2, 2, .production_id = 22),
  [132] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_form_data_repeat2, 2, .production_id = 22), SHIFT_REPEAT(215),
  [135] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_form_data_repeat2, 2, .production_id = 22), SHIFT_REPEAT(157),
  [138] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_form_data, 4, .production_id = 19),
  [140] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_form_data, 4, .production_id = 19),
  [142] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_boolean, 1),
  [144] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_boolean, 1),
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_form_data_repeat2, 4, .production_id = 24),
  [148] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_form_data_repeat2, 4, .production_id = 24),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_host, 1),
  [152] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_host, 1),
  [154] = {.entry = {.count = 1, .reusable = true}}, SHIFT(223),
  [156] = {.entry = {.count = 1, .reusable = true}}, SHIFT(183),
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_request_repeat1, 2),
  [160] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_request_repeat1, 2), SHIFT_REPEAT(210),
  [163] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_request_repeat1, 2),
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_graphql_body, 6),
  [167] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_graphql_body, 6),
  [169] = {.entry = {.count = 1, .reusable = false}}, SHIFT(48),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_external_body, 5, .production_id = 20),
  [173] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_external_body, 5, .production_id = 20),
  [175] = {.entry = {.count = 1, .reusable = false}}, SHIFT(44),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_external_body, 3, .production_id = 14),
  [179] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_external_body, 3, .production_id = 14),
  ...
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_graphql_body, 5),
  [191] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_graphql_body, 5),
  [193] = {.entry = {.count = 1, .reusable = false}}, SHIFT(55),
  [195] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_xml_body, 4),
  [197] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_xml_body, 4),
  [199] = {.entry = {.count = 1, .reusable = false}}, SHIFT(45),
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_port, 2),
  [203] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_port, 2),
  [205] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_external_body, 4, .production_id = 14),
  [207] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_external_body, 4, .production_id = 14),
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_host_url, 2),
  [211] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_host_url, 2),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_header, 4, .production_id = 17),
  [215] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_header, 4, .production_id = 17),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_json_body, 4),
  [219] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_json_body, 4),
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_host, 2),
  [223] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_host, 2),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 5, .production_id = 4),
  [227] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable, 5, .production_id = 4),
  [229] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_external_body, 6, .production_id = 20),
  [231] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_external_body, 6, .production_id = 20),
  [233] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_xml_body, 5),
  [235] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_xml_body, 5),
  [237] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 3, .production_id = 1),
  [239] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable, 3, .production_id = 1),
  [241] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_host_url, 4),
  [243] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_host_url, 4),
  [245] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_graphql_body, 7),
  [247] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_graphql_body, 7),
  [249] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_header, 3, .production_id = 15),
  [251] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_header, 3, .production_id = 15),
  [253] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_header, 6, .production_id = 23),
  [255] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_header, 6, .production_id = 23),
  [257] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_host_url, 1),
  [259] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_host_url, 1),
  [261] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_header, 5, .production_id = 21),
  [263] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_header, 5, .production_id = 21),
  [265] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_header, 4, .production_id = 18),
  [267] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_header, 4, .production_id = 18),
  [269] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 4, .production_id = 1),
  [271] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable, 4, .production_id = 1),
  [273] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 4, .production_id = 4),
  [275] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable, 4, .production_id = 4),
  [277] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_host_url, 3),
  [279] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_host_url, 3),
  [281] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2),
  [283] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(59),
  [286] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(190),
  [289] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(224),
  [292] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(150),
  [295] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(195),
  [298] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_document, 1),
  ...
  [312] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_target_url, 1),
  [314] = {.entry = {.count = 1, .reusable = false}}, SHIFT(106),
  [316] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_path_repeat1, 1),
  [318] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_path_repeat1, 1),
  [320] = {.entry = {.count = 1, .reusable = false}}, SHIFT(135),
  [322] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__whitespace, 2), SHIFT_REPEAT(65),
  ...
  [337] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_query_param, 2, .production_id = 7),
  [339] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_query_param, 2, .production_id = 7),
  [341] = {.entry = {.count = 1, .reusable = false}}, SHIFT(99),
  [343] = {.entry = {.count = 1, .reusable = false}}, SHIFT(124),
  [345] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_path_repeat1, 2), SHIFT_REPEAT(62),
  [348] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_path_repeat1, 2),
  [350] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_path_repeat1, 2),
  [352] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_declaration, 6, .production_id = 12),
  [354] = {.entry = {.count = 1, .reusable = false}}, SHIFT(62),
  [356] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_path, 1),
  [358] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_path, 1),
  [360] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_target_url_repeat1, 2),
  [362] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_target_url_repeat1, 2),
  [364] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_target_url_repeat1, 2), SHIFT_REPEAT(217),
  [367] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_target_url_repeat1, 2), SHIFT_REPEAT(96),
  [370] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_script_variable, 3),
  ...
  [380] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_target_url, 3),
  ...
  [392] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_target_url, 6),
  [394] = {.entry = {.count = 1, .reusable = true}}, SHIFT(180),
  [396] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_target_url, 5),
  [398] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_declaration, 4, .production_id = 3),
  ...
  [406] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_target_url, 2),
  [408] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_declaration, 5, .production_id = 9),
  [410] = {.entry = {.count = 1, .reusable = true}}, SHIFT(228),
  [412] = {.entry = {.count = 1, .reusable = true}}, SHIFT(122),
  [414] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_target_url, 3),
  [416] = {.entry = {.count = 1, .reusable = true}}, SHIFT(181),
  [418] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_target_url, 7),
  [420] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_target_url, 2),
  [422] = {.entry = {.count = 1, .reusable = true}}, SHIFT(177),
  [424] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_target_url, 4),
  [426] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_target_url, 1),
  [428] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_query_param, 1, .production_id = 2),
  [430] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_query_param, 1, .production_id = 2),
  ...
  [438] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_target_url, 4),
  [440] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_query_param, 3, .production_id = 7),
  [442] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_query_param, 3, .production_id = 7),
  [444] = {.entry = {.count = 1, .reusable = false}}, SHIFT(115),
  [446] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_path_repeat1, 2), SHIFT_REPEAT(68),
  [449] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_query_param, 2, .production_id = 2),
  [451] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_query_param, 2, .production_id = 2),
  [453] = {.entry = {.count = 1, .reusable = false}}, SHIFT(123),
  [455] = {.entry = {.count = 1, .reusable = true}}, SHIFT(85),
  [457] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_path_repeat1, 3),
  [459] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_path_repeat1, 3),
  [461] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [463] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_path_repeat1, 2), SHIFT_REPEAT(104),
  [466] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [468] = {.entry = {.count = 1, .reusable = false}}, SHIFT(114),
  [470] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_path_repeat1, 2), SHIFT_REPEAT(125),
  [473] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_script_variable_repeat1, 2),
  [475] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_script_variable_repeat1, 2), SHIFT_REPEAT(114),
  [478] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_query_param, 4, .production_id = 13),
  [480] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_query_param, 4, .production_id = 13),
  ...
  [488] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_authority, 2),
  [490] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_query_param, 2, .production_id = 8),
  [492] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_query_param, 2, .production_id = 8),
  [494] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__whitespace, 2), SHIFT_REPEAT(171),
  [497] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_query_param, 3, .production_id = 11),
  [499] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_query_param, 3, .production_id = 11),
  [501] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_query_param, 3, .production_id = 10),
  [503] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_query_param, 3, .production_id = 10),
  ...
  [511] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_target_url, 5),
  [513] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_form_data_repeat1, 2),
  [515] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_form_data_repeat1, 2), SHIFT_REPEAT(133),
  ...
  [554] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__whitespace, 2), SHIFT_REPEAT(175),
  [557] = {.entry = {.count = 1, .reusable = true}}, SHIFT(160),
  [559] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_script_variable_repeat1, 2), SHIFT_REPEAT(151),
  ...
  [568] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__whitespace, 2), SHIFT_REPEAT(194),
  [571] = {.entry = {.count = 1, .reusable = true}}, SHIFT(69),
  [573] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_script_variable_repeat1, 2), SHIFT_REPEAT(156),
  ...
  [602] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_script_variable_repeat1, 2), SHIFT_REPEAT(168),
  ...
  [639] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pair, 3, .production_id = 5),
  [641] = {.entry = {.count = 1, .reusable = true}}, SHIFT(78),
  [643] = {.entry = {.count = 1, .reusable = true}}, SHIFT(103),
  [645] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fragment, 1, .production_id = 6),
  [647] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scheme, 1),
  [649] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_target_url, 6),
  [651] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_target_url, 7),
  [653] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_http_version, 2),
  ...
  [669] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_target_url, 9),
  ...
  [681] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_target_url, 8),
  ...
  [689] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_response, 5),
