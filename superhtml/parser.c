...
extern "C" {
#endif
void *tree_sitter_superhtml_external_scanner_create(void);
void tree_sitter_superhtml_external_scanner_destroy(void *);
bool tree_sitter_superhtml_external_scanner_scan(void *, TSLexer *, const bool *);
unsigned tree_sitter_superhtml_external_scanner_serialize(void *, char *);
void tree_sitter_superhtml_external_scanner_deserialize(void *, const char *, unsigned);
...
TS_PUBLIC const TSLanguage *tree_sitter_superhtml(void) {
  static const TSLanguage language = {
    ...
    .external_scanner = {
      ...
      tree_sitter_superhtml_external_scanner_create,
      tree_sitter_superhtml_external_scanner_destroy,
      tree_sitter_superhtml_external_scanner_scan,
      tree_sitter_superhtml_external_scanner_serialize,
      tree_sitter_superhtml_external_scanner_deserialize,
    },
