...
static void deserialize_php(Scanner *scanner, const char *buffer, unsigned length) {
    unsigned size = 0;
...
static bool scan_php(Scanner *scanner, TSLexer *lexer, const bool *valid_symbols) {
...
static inline unsigned external_scanner_serialize(void *payload, char *buffer) {
    ...
    return serialize_php(scanner, buffer);
}

static inline void external_scanner_deserialize(void *payload, const char *buffer, unsigned length) {
    Scanner *scanner = (Scanner *)payload;
    deserialize_php(scanner, buffer, length);
}

static inline bool external_scanner_scan(void *payload, TSLexer *lexer, const bool *valid_symbols) {
    Scanner *scanner = (Scanner *)payload;
    return scan_php(scanner, lexer, valid_symbols);
}
