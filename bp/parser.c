...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_select_cases_repeat1, 2, 0, 0),
  [39] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_select_cases_repeat1, 2, 0, 0), SHIFT_REPEAT(17),
  [42] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_select_cases_repeat1, 2, 0, 0), SHIFT_REPEAT(18),
  [45] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_select_cases_repeat1, 2, 0, 0), SHIFT_REPEAT(23),
  [48] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_select_cases_repeat1, 2, 0, 0), SHIFT_REPEAT(46),
  [51] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_select_cases_repeat1, 2, 0, 0), SHIFT_REPEAT(41),
  [54] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_select_cases_repeat1, 2, 0, 0), SHIFT_REPEAT(64),
  ...
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpreted_string_literal, 2, 0, 0),
  [77] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1, 0, 0),
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpreted_string_literal, 3, 0, 0),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__string_literal, 1, 0, 0),
  ...
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 4, 0, 6),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 5, 0, 11),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 4, 0, 12),
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 3, 0, 7),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 5, 0, 12),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 4, 0, 11),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 4, 0, 5),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 3, 0, 5),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 2, 0, 0),
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 3, 0, 6),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_integer_literal, 2, 0, 0),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_integer_literal, 1, 0, 0),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expr, 1, 0, 0),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 2, 0, 0),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_expression, 6, 0, 0),
  [118] = {.entry = {.count = 1, .reusable = true}}, SHIFT(96),
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__select_pattern, 1, 0, 0),
  ...
  [152] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 2, 0, 0), SHIFT_REPEAT(52),
  [155] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 2, 0, 0),
  [157] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 2, 0, 0), SHIFT_REPEAT(52),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__equal_property, 3, 0, 8),
  ...
  [168] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 1, 0, 0),
  [170] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 1, 0, 0),
  [172] = {.entry = {.count = 1, .reusable = true}}, SHIFT(112),
  [174] = {.entry = {.count = 1, .reusable = true}}, SHIFT(120),
  [176] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_select_pattern_repeat1, 2, 0, 0), SHIFT_REPEAT(16),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_select_pattern_repeat1, 2, 0, 0),
  ...
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern_binding, 3, 0, 17),
  ...
  [207] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_condition_repeat1, 2, 0, 0), SHIFT_REPEAT(47),
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_condition_repeat1, 2, 0, 0),
  [212] = {.entry = {.count = 1, .reusable = true}}, SHIFT(4),
  [214] = {.entry = {.count = 1, .reusable = true}}, SHIFT(27),
  [216] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__colon_property, 3, 0, 8),
  ...
  [228] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__old_module_repeat1, 2, 0, 10), SHIFT_REPEAT(92),
  [231] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__old_module_repeat1, 2, 0, 10),
  [233] = {.entry = {.count = 1, .reusable = true}}, SHIFT(56),
  [235] = {.entry = {.count = 1, .reusable = true}}, SHIFT(89),
  [237] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_select_value_repeat1, 2, 0, 0), SHIFT_REPEAT(99),
  [240] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_select_value_repeat1, 2, 0, 0),
  [242] = {.entry = {.count = 1, .reusable = true}}, SHIFT(93),
  [244] = {.entry = {.count = 1, .reusable = true}}, SHIFT(118),
  [246] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__new_module_repeat1, 2, 0, 10), SHIFT_REPEAT(94),
  [249] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__new_module_repeat1, 2, 0, 10),
  ...
  [261] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_list_expression_repeat1, 2, 0, 13), SHIFT_REPEAT(10),
  [264] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_list_expression_repeat1, 2, 0, 13),
  [266] = {.entry = {.count = 1, .reusable = true}}, SHIFT(75),
  [268] = {.entry = {.count = 1, .reusable = true}}, SHIFT(53),
  [270] = {.entry = {.count = 1, .reusable = true}}, SHIFT(97),
  [272] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_list_expression_repeat1, 2, 0, 6),
  [274] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 3, 0, 2),
  [276] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__new_module, 5, 0, 4),
  [278] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [280] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__new_module, 4, 0, 4),
  [282] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__old_module, 3, 0, 3),
  [284] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__old_module, 6, 0, 9),
  [286] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__new_module, 6, 0, 9),
  [288] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 3, 0, 14),
  [290] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__old_module, 4, 0, 4),
  [292] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__case_value, 1, 0, 0),
  [294] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__new_module, 3, 0, 3),
  ...
  [300] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 1, 0, 1),
  [302] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__new_module, 5, 0, 9),
  [304] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 4, 0, 15),
  [306] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__new_module_repeat1, 2, 0, 5),
  [308] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 5, 0, 16),
  [310] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__old_module, 5, 0, 9),
  [312] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__old_module_repeat1, 2, 0, 5),
  [314] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__old_module, 5, 0, 4),
  [316] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [318] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_cases, 3, 0, 0),
  ...
  [332] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_value, 1, 0, 0),
  [334] = {.entry = {.count = 1, .reusable = true}}, SHIFT(88),
  [336] = {.entry = {.count = 1, .reusable = true}}, SHIFT(57),
  [338] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_cases, 2, 0, 0),
  [340] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_pattern, 5, 0, 0),
  [342] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_pattern, 1, 0, 0),
  [344] = {.entry = {.count = 1, .reusable = false}}, SHIFT(141),
  [346] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_value, 4, 0, 0),
  [348] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_pattern, 3, 0, 0),
  [350] = {.entry = {.count = 1, .reusable = true}}, SHIFT(40),
  [352] = {.entry = {.count = 1, .reusable = true}}, SHIFT(7),
  [354] = {.entry = {.count = 1, .reusable = true}}, SHIFT(39),
  [356] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_case, 3, 0, 18),
  [358] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_pattern, 4, 0, 0),
  [360] = {.entry = {.count = 1, .reusable = true}}, SHIFT(43),
  [362] = {.entry = {.count = 1, .reusable = true}},  ACCEPT_INPUT(),
  [364] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_value, 3, 0, 0),
  [366] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 3, 0, 0),
