...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym__old_module] = STATE(101),
    [sym__new_module] = STATE(111),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [47] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_select_cases_repeat1, 2, 0, 0),
  [49] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_select_cases_repeat1, 2, 0, 0), SHIFT_REPEAT(17),
  [52] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_select_cases_repeat1, 2, 0, 0), SHIFT_REPEAT(19),
  [55] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_select_cases_repeat1, 2, 0, 0), SHIFT_REPEAT(20),
  [58] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_select_cases_repeat1, 2, 0, 0), SHIFT_REPEAT(47),
  [61] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_select_cases_repeat1, 2, 0, 0), SHIFT_REPEAT(44),
  [64] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_select_cases_repeat1, 2, 0, 0), SHIFT_REPEAT(76),
  ...
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__string_literal, 1, 0, 0),
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1, 0, 0),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpreted_string_literal, 2, 0, 0),
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpreted_string_literal, 3, 0, 0),
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_expression, 6, 0, 0),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 4, 0, 11),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 3, 0, 7),
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 4, 0, 5),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 4, 0, 6),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 5, 0, 11),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 4, 0, 12),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 5, 0, 12),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 2, 0, 0),
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 3, 0, 5),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_integer_literal, 1, 0, 0),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 2, 0, 0),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_integer_literal, 2, 0, 0),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expr, 1, 0, 0),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 3, 0, 6),
  [118] = {.entry = {.count = 1, .reusable = true}}, SHIFT(93),
  [120] = {.entry = {.count = 1, .reusable = false}}, SHIFT(139),
  ...
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__select_pattern, 1, 0, 0),
  ...
  [152] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 2, 0, 0), SHIFT_REPEAT(70),
  [155] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 2, 0, 0),
  [157] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 2, 0, 0), SHIFT_REPEAT(70),
  ...
  [170] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 3, 0, 2),
  [172] = {.entry = {.count = 1, .reusable = true}}, SHIFT(5),
  [174] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__colon_property, 3, 0, 8),
  [178] = {.entry = {.count = 1, .reusable = true}}, SHIFT(87),
  [180] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__old_module_repeat1, 2, 0, 10), SHIFT_REPEAT(88),
  [183] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__old_module_repeat1, 2, 0, 10),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__equal_property, 3, 0, 8),
  [187] = {.entry = {.count = 1, .reusable = true}}, SHIFT(89),
  [189] = {.entry = {.count = 1, .reusable = true}}, SHIFT(130),
  [191] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__new_module_repeat1, 2, 0, 10), SHIFT_REPEAT(90),
  [194] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__new_module_repeat1, 2, 0, 10),
  ...
  [206] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_list_expression_repeat1, 2, 0, 6),
  ...
  [228] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 1, 0, 0),
  [230] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 1, 0, 0),
  [232] = {.entry = {.count = 1, .reusable = true}}, SHIFT(106),
  [234] = {.entry = {.count = 1, .reusable = true}}, SHIFT(118),
  [236] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_select_value_repeat1, 2, 0, 0), SHIFT_REPEAT(102),
  [239] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_select_value_repeat1, 2, 0, 0),
  [241] = {.entry = {.count = 1, .reusable = true}}, SHIFT(104),
  [243] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [245] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_condition_repeat1, 2, 0, 0), SHIFT_REPEAT(46),
  [248] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_condition_repeat1, 2, 0, 0),
  ...
  [262] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern_binding, 3, 0, 17),
  [264] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_select_pattern_repeat1, 2, 0, 0), SHIFT_REPEAT(16),
  [267] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_select_pattern_repeat1, 2, 0, 0),
  [269] = {.entry = {.count = 1, .reusable = true}}, SHIFT(94),
  [271] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_list_expression_repeat1, 2, 0, 13), SHIFT_REPEAT(10),
  [274] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_list_expression_repeat1, 2, 0, 13),
  [276] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__old_module, 6, 0, 9),
  [278] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__new_module, 6, 0, 9),
  [280] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__new_module, 4, 0, 4),
  [282] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__old_module, 5, 0, 9),
  [284] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 3, 0, 14),
  [286] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__new_module, 5, 0, 4),
  [288] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__new_module_repeat1, 2, 0, 5),
  [290] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__new_module, 5, 0, 9),
  [292] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 1, 0, 0),
  [294] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 4, 0, 15),
  [296] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__definition, 1, 0, 0),
  [298] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 1, 0, 1),
  [300] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 5, 0, 16),
  [302] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__old_module, 3, 0, 3),
  [304] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__new_module, 3, 0, 3),
  [306] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__old_module, 4, 0, 4),
  [308] = {.entry = {.count = 1, .reusable = true}}, SHIFT(11),
  [310] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__case_value, 1, 0, 0),
  [312] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__old_module, 5, 0, 4),
  [314] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__old_module_repeat1, 2, 0, 5),
  [316] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [318] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_pattern, 1, 0, 0),
  [320] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_value, 3, 0, 0),
  [322] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_value, 4, 0, 0),
  [324] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_value, 5, 0, 0),
  [326] = {.entry = {.count = 1, .reusable = true}}, SHIFT(108),
  [328] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_value, 1, 0, 0),
  ...
  [340] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_cases, 3, 0, 0),
  [342] = {.entry = {.count = 1, .reusable = false}}, SHIFT(141),
  [344] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_cases, 2, 0, 0),
  [346] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_pattern, 3, 0, 0),
  [348] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [350] = {.entry = {.count = 1, .reusable = true}}, SHIFT(43),
  [352] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_pattern, 4, 0, 0),
  [354] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_case, 3, 0, 18),
  [356] = {.entry = {.count = 1, .reusable = false}}, SHIFT(127),
  [358] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [360] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_pattern, 5, 0, 0),
  [362] = {.entry = {.count = 1, .reusable = true}}, SHIFT(23),
  [364] = {.entry = {.count = 1, .reusable = false}}, SHIFT(140),
  [366] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 2, 0, 0),
