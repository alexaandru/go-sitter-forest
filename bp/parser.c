...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [66] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpreted_string_literal, 2, 0, 0),
  [68] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__string_literal, 1, 0, 0),
  [70] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expr, 1, 0, 0),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 4, 0, 5),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 3, 0, 5),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 3, 0, 6),
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 3, 0, 7),
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 4, 0, 6),
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 4, 0, 11),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 2, 0, 0),
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 4, 0, 12),
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_integer_literal, 2, 0, 0),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 5, 0, 11),
  ...
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_integer_literal, 1, 0, 0),
