...
parsers built into the binary whereas all parsers built as plugins take \~1650MB),
...
We are currently aligned with TreeSitter `v0.22.1`: [go-tree-sitter-bare](https://github.com/alexaandru/go-tree-sitter-bare)
`v1.1.0` uses `v0.22.1` (and this project uses that latest version of
