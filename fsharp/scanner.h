...
static bool scan_fsharp(Scanner *scanner, TSLexer *lexer, const bool *valid_symbols) {
...
static unsigned serialize_fsharp(Scanner *scanner, char *buffer) {
  size_t size = 0;
...
static void deserialize_fsharp(Scanner *scanner, const char *buffer, unsigned length) {
...
static Scanner *create() {
  ...
  deserialize_fsharp(scanner, NULL, 0);
  return scanner;
}
