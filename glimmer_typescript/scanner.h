...
static void advance_glimmer_typescript(TSLexer *lexer) { lexer->advance_glimmer_typescript(lexer, false); }

static void skip_glimmer_typescript(TSLexer *lexer) { lexer->advance_glimmer_typescript(lexer, true); }
