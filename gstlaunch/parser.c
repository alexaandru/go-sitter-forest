  ...
  switch (state) {
    case 0:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(0);
      if (set_contains(sym_identifier_character_set_1, 657, lookahead)) ADVANCE(33);
      END_STATE();
    case 1:
      if (lookahead == '\n') SKIP(8);
      END_STATE();
    ...
    case 33:
      ...
      if (set_contains(sym_identifier_character_set_2, 765, lookahead)) ADVANCE(33);
      END_STATE();
    case 34:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_bin] = STATE(37),
    [sym_simple_element] = STATE(37),
    [sym_reference] = STATE(37),
    [sym_caps] = STATE(37),
    [sym_cap] = STATE(25),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [17] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_pipeline_repeat1, 2, 0, 0), SHIFT_REPEAT(49),
  ...
  [27] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_cap_repeat1, 2, 0, 0),
  [29] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_cap_repeat1, 2, 0, 0), SHIFT_REPEAT(47),
  [32] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_simple_element, 1, 0, 1),
  [34] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_simple_element, 1, 0, 1), SHIFT(44),
  [37] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_simple_element, 1, 0, 1), SHIFT(48),
  [40] = {.entry = {.count = 1, .reusable = true}}, SHIFT(50),
  [42] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_cap, 6, 0, 0),
  [44] = {.entry = {.count = 1, .reusable = true}}, SHIFT(47),
  [46] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_cap, 5, 0, 0),
  [48] = {.entry = {.count = 1, .reusable = true}}, SHIFT(40),
  [50] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_property, 3, 0, 7),
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_reference, 4, 0, 6),
  [54] = {.entry = {.count = 1, .reusable = true}}, SHIFT(52),
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_simple_element, 2, 0, 1),
  [58] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_simple_element, 2, 0, 1), SHIFT(48),
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_caps, 2, 0, 0),
  [63] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_reference, 3, 0, 3),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_reference, 3, 0, 4),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_literal, 3, 0, 0),
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_cap, 3, 0, 0),
  [73] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_bin_repeat1, 2, 0, 0),
  [77] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_bin_repeat1, 2, 0, 0), SHIFT_REPEAT(48),
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_literal, 2, 0, 0),
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_caps, 1, 0, 0),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_caps_repeat1, 2, 0, 0),
  [86] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_caps_repeat1, 2, 0, 0), SHIFT_REPEAT(45),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_reference_repeat1, 2, 0, 5),
  [91] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_reference_repeat1, 2, 0, 5), SHIFT_REPEAT(52),
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_reference, 2, 0, 2),
  ...
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bin, 4, 0, 1),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bin, 5, 0, 1),
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_element, 1, 0, 0),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bin, 6, 0, 1),
