...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_identifier_character_set_1, 723, lookahead)) ADVANCE(41);
      END_STATE();
    case 1:
      ADVANCE_MAP(
        '\n', 44,
    ...
    case 41:
      ...
      if (set_contains(sym_identifier_character_set_2, 740, lookahead)) ADVANCE(41);
      END_STATE();
    case 42:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [61] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_template_global_repeat1, 2, 0, 5),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_template_global_repeat1, 2, 0, 5),
  [65] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_template_global_repeat1, 2, 0, 5), SHIFT_REPEAT(213),
  [68] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_global, 2, 0, 2),
  [70] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_global, 2, 0, 2),
  [72] = {.entry = {.count = 1, .reusable = true}}, SHIFT(213),
  [74] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_global, 2, 0, 15),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_global, 2, 0, 15),
  [78] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_global, 3, 0, 26),
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_global, 3, 0, 26),
  [82] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_global, 1, 0, 1),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_global, 1, 0, 1),
  [86] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary_op, 2, 0, 14),
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_op, 2, 0, 14),
  [90] = {.entry = {.count = 1, .reusable = false}}, SHIFT(243),
  [92] = {.entry = {.count = 1, .reusable = true}}, SHIFT(63),
  [94] = {.entry = {.count = 1, .reusable = true}}, SHIFT(80),
  [96] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_params, 4, 0, 31),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_params, 4, 0, 31),
  [100] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_op, 3, 0, 29),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_op, 3, 0, 29),
  ...
  [118] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_params, 7, 0, 52),
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_params, 7, 0, 52),
  [122] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_params, 6, 0, 51),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_params, 6, 0, 51),
  [126] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_params, 6, 0, 50),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_params, 6, 0, 50),
  [130] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_params, 5, 0, 6),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_params, 5, 0, 6),
  [134] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_params, 5, 0, 49),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_params, 5, 0, 49),
  [138] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_params, 5, 0, 38),
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_params, 5, 0, 38),
  [142] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_params, 4, 0, 3),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_params, 4, 0, 3),
  [146] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_params, 3, 0, 0),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_params, 3, 0, 0),
  [150] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_template_global_repeat1, 2, 0, 3),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_template_global_repeat1, 2, 0, 3),
  [154] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_array_bracket_expression, 3, 0, 25),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array_bracket_expression, 3, 0, 25),
  [158] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parenthesis_expression, 3, 0, 25),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parenthesis_expression, 3, 0, 25),
  [162] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parenthesis_expression_list, 3, 0, 3),
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parenthesis_expression_list, 3, 0, 3),
  [166] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parenthesis_expression_list, 2, 0, 0),
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parenthesis_expression_list, 2, 0, 0),
  [170] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_field_access, 3, 0, 30),
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_access, 3, 0, 30),
  [174] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parenthesis_expression_list, 4, 0, 6),
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parenthesis_expression_list, 4, 0, 6),
  [178] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_array_op, 2, 0, 18),
  [180] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array_op, 2, 0, 18),
  [182] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_func_call, 2, 0, 19),
  [184] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_func_call, 2, 0, 19),
  [186] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__linebreak, 2, 0, 0),
  [188] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__linebreak, 2, 0, 0),
  [190] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__linebreak, 2, 0, 0), SHIFT_REPEAT(42),
  [193] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [195] = {.entry = {.count = 1, .reusable = false}}, SHIFT(82),
  [197] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_latency_specifier, 2, 0, 25),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_latency_specifier, 2, 0, 25),
  [201] = {.entry = {.count = 1, .reusable = true}}, SHIFT(82),
  [203] = {.entry = {.count = 1, .reusable = true}}, SHIFT(243),
  [205] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_assign_to, 2, 0, 16),
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assign_to, 2, 0, 16),
  [209] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_assign_to, 1, 0, 9),
  [211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assign_to, 1, 0, 9),
  ...
  [225] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__type, 1, 0, 0), REDUCE(sym__expression, 1, 0, 0),
  ...
  [234] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parenthesis_expression_list_repeat1, 2, 0, 3),
  [236] = {.entry = {.count = 1, .reusable = true}}, SHIFT(107),
  [238] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_decl_assign_statement, 3, 0, 27),
  [240] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_value_param, 1, 0, 37),
  [242] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_value_param, 3, 0, 47),
  ...
  [266] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__comma, 2, 0, 0),
  [268] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__comma, 2, 0, 0),
  [270] = {.entry = {.count = 1, .reusable = true}}, SHIFT(57),
  [272] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [274] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__comma, 1, 0, 0),
  [276] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__comma, 1, 0, 0),
  ...
  [302] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_write_modifiers, 1, 0, 10),
  [304] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_write_modifiers, 1, 0, 10),
  [306] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_write_modifiers_repeat1, 2, 0, 5),
  [308] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_write_modifiers_repeat1, 2, 0, 5), SHIFT_REPEAT(85),
  [311] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_write_modifiers_repeat1, 2, 0, 5),
  [313] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_write_modifiers_repeat1, 1, 0, 1),
  [315] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_write_modifiers_repeat1, 1, 0, 1),
  [317] = {.entry = {.count = 1, .reusable = true}}, SHIFT(90),
  [319] = {.entry = {.count = 1, .reusable = true}}, SHIFT(86),
  [321] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_write_modifiers, 1, 0, 1),
  [323] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_write_modifiers, 1, 0, 1),
  [325] = {.entry = {.count = 1, .reusable = true}}, SHIFT(89),
  [327] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 3, 0, 2),
  [329] = {.entry = {.count = 1, .reusable = true}}, SHIFT(99),
  [331] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1, 0, 0),
  [333] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 3, 0, 3),
  [335] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 2, 0, 1),
  [337] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 4, 0, 6),
  [339] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 2, 0, 17),
  [341] = {.entry = {.count = 1, .reusable = true}}, SHIFT(77),
  [343] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__linebreak, 2, 0, 0), SHIFT_REPEAT(99),
  [346] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 4, 0, 34),
  [348] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 3, 0, 23),
  [350] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 3, 0, 24),
  ...
  [370] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 5, 0, 44),
  [372] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assign_left_side, 1, 0, 1),
  [374] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_declaration_list_repeat1, 2, 0, 5),
  [376] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_declaration_list_repeat1, 2, 0, 5), SHIFT_REPEAT(71),
  [379] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assign_left_side, 2, 0, 2),
  [381] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration_list, 1, 0, 1),
  [383] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 4, 0, 35),
  [385] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 4, 0, 36),
  [387] = {.entry = {.count = 1, .reusable = true}}, SHIFT(131),
  [389] = {.entry = {.count = 1, .reusable = true}}, SHIFT(212),
  [391] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 3, 0, 28),
  [393] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_assign_left_side_repeat1, 2, 0, 5),
  [395] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_assign_left_side_repeat1, 2, 0, 5), SHIFT_REPEAT(71),
  [398] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration_list, 2, 0, 2),
  [400] = {.entry = {.count = 1, .reusable = true}}, SHIFT(75),
  [402] = {.entry = {.count = 1, .reusable = true}}, SHIFT(172),
  [404] = {.entry = {.count = 1, .reusable = true}}, SHIFT(4),
  [406] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_template_global_repeat1, 2, 0, 5), SHIFT_REPEAT(212),
  ...
  [415] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_statement, 2, 0, 13),
  [417] = {.entry = {.count = 1, .reusable = true}}, SHIFT(87),
  [419] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 2, 0, 2),
  [421] = {.entry = {.count = 1, .reusable = true}}, SHIFT(93),
  [423] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_assign_left_side_repeat1, 2, 0, 3),
  [425] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 4, 0, 6),
  [427] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 4, 0, 31),
  [429] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 5),
  [431] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 5), SHIFT_REPEAT(10),
  ...
  [448] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_ports, 2, 0, 33),
  [450] = {.entry = {.count = 1, .reusable = true}}, SHIFT(173),
  [452] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 4, 0, 3),
  ...
  [462] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_template_declaration_arguments_repeat1, 2, 0, 5),
  [464] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_template_declaration_arguments_repeat1, 2, 0, 5), SHIFT_REPEAT(71),
  ...
  [473] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 5, 0, 6),
  [475] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_declaration_type, 3, 0, 20),
  ...
  [483] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array_type, 2, 0, 18),
  [485] = {.entry = {.count = 1, .reusable = true}}, SHIFT(39),
  [487] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 5, 0, 31),
  [489] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 5, 0, 38),
  ...
  [501] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 3, 0, 6),
  [503] = {.entry = {.count = 1, .reusable = true}}, SHIFT(97),
  [505] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 3, 0, 3),
  [507] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_ports, 3, 0, 43),
  [509] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_type_param, 1, 0, 37),
  ...
  [517] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 2, 0, 3),
  [519] = {.entry = {.count = 1, .reusable = true}}, SHIFT(95),
  [521] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parenthesis_expression_list_repeat1, 2, 0, 5),
  [523] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parenthesis_expression_list_repeat1, 2, 0, 5), SHIFT_REPEAT(71),
  [526] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 6, 0, 38),
  [528] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 5),
  [530] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 5), SHIFT_REPEAT(103),
  ...
  [545] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_template_params_repeat1, 2, 0, 5),
  [547] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_template_params_repeat1, 2, 0, 5), SHIFT_REPEAT(71),
  [550] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_type_param, 3, 0, 47),
  [552] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_template_params_repeat2, 2, 0, 5),
  [554] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_template_params_repeat2, 2, 0, 5), SHIFT_REPEAT(71),
  ...
  [567] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_declaration_type, 1, 0, 8),
  [569] = {.entry = {.count = 1, .reusable = true}}, SHIFT(132),
  [571] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 3, 0, 21),
  ...
  [591] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 3),
  [593] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_global_object, 4, 0, 7),
  [595] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_for_statement, 7, 0, 48),
  [597] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_ports, 4, 0, 46),
  [599] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 3),
  [601] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_global_object, 3, 0, 4),
  [603] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__interface_ports_output, 3, 0, 45),
  [605] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_global_object, 4, 0, 11),
  [607] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_global_object, 5, 0, 12),
  [609] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_ports, 2, 0, 32),
  [611] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_template_params_repeat1, 2, 0, 3),
  [613] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_domain_statement, 2, 0, 13),
  [615] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_template_params_repeat2, 2, 0, 3),
  [617] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_ports, 3, 0, 42),
  [619] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_statement, 3, 0, 22),
  [621] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_template_declaration_arguments_repeat1, 2, 0, 3),
  [623] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 5, 0, 39),
  [625] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_ports, 3, 0, 41),
  [627] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__interface_ports_output, 2, 0, 40),
  ...
  [637] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_declaration_arguments, 4, 0, 6),
  ...
  [651] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_declaration_arguments, 3, 0, 3),
};
