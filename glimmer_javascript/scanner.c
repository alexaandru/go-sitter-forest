...
//  - find and replace "tree_sitter_javascript" with "tree_sitter_glimmer_javascript"
//    - there should be 5 methods updated
//    - %s/tree_sitter_javascript/tree_sitter_glimmer_javascript/g
//
//
//
// ----------------------------------------------------------
...
void *tree_sitter_glimmer_javascript_external_scanner_create() { return NULL; }

void tree_sitter_glimmer_javascript_external_scanner_destroy(void *p) {}

unsigned tree_sitter_glimmer_javascript_external_scanner_serialize(void *p, char *buffer) { return 0; }

void tree_sitter_glimmer_javascript_external_scanner_deserialize(void *p, const char *b, unsigned n) {}
