...
static TSCharacterRange sym_entry_type_character_set_1[] = {
  {'!', '!'}, {'$', '$'}, {'&', '&'}, {'*', '+'}, {'-', '/'}, {':', '<'}, {'>', 'z'}, {'|', '|'},
  {'~', '~'},
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 4:
      ...
      if (set_contains(sym_entry_type_character_set_1, 9, lookahead)) ADVANCE(34);
      END_STATE();
    case 5:
      if (eof) ADVANCE(6);
    ...
    case 8:
      ...
      if (set_contains(sym_entry_type_character_set_1, 9, lookahead) ||
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [20] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_document_repeat1, 2, 0, 0), SHIFT_REPEAT(2),
  [23] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_document_repeat1, 2, 0, 0), SHIFT_REPEAT(66),
  [26] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_document_repeat1, 2, 0, 0), SHIFT_REPEAT(65),
  [29] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_document_repeat1, 2, 0, 0), SHIFT_REPEAT(64),
  ...
  [38] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_token_repeat2, 2, 0, 0), SHIFT_REPEAT(9),
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_token_repeat2, 2, 0, 0),
  [43] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_token_repeat2, 2, 0, 0), SHIFT_REPEAT(19),
  [46] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_token_repeat2, 2, 0, 0), SHIFT_REPEAT(39),
  ...
  [73] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_token_repeat1, 2, 0, 0), SHIFT_REPEAT(7),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_token_repeat1, 2, 0, 0),
  [78] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_token_repeat1, 2, 0, 0), SHIFT_REPEAT(21),
  [81] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_token_repeat1, 2, 0, 0), SHIFT_REPEAT(48),
  ...
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__quote_balanced_repeat1, 2, 0, 0),
  [94] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__quote_balanced_repeat1, 2, 0, 0), SHIFT_REPEAT(18),
  [97] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__quote_balanced_repeat1, 2, 0, 0), SHIFT_REPEAT(39),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__quote_balanced, 1, 0, 0),
  [102] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entry, 5, 0, 3),
  [106] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_entry, 5, 0, 3),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__brace_balanced, 1, 0, 0),
  ...
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__brace_balanced_repeat1, 2, 0, 0),
  [120] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__brace_balanced_repeat1, 2, 0, 0), SHIFT_REPEAT(24),
  [123] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__brace_balanced_repeat1, 2, 0, 0), SHIFT_REPEAT(48),
  [126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entry, 4, 0, 3),
  [128] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_entry, 4, 0, 3),
  [130] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entry, 5, 0, 5),
  [132] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_entry, 5, 0, 5),
  [134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 6, 0, 7),
  [136] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string, 6, 0, 7),
  [138] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_preamble, 4, 0, 2),
  [140] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_preamble, 4, 0, 2),
  [142] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entry, 6, 0, 5),
  [144] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_entry, 6, 0, 5),
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__quote_balanced, 2, 0, 0),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_value_repeat1, 2, 0, 0),
  [150] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_value_repeat1, 2, 0, 0), SHIFT_REPEAT(42),
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_value, 1, 0, 0),
  [155] = {.entry = {.count = 1, .reusable = true}}, SHIFT(42),
  [157] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__quote_balanced, 3, 0, 0),
  [159] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 1, 0, 1),
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 3, 0, 1),
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 4, 0, 1),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_value, 2, 0, 0),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__brace_balanced, 2, 0, 0),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_token, 3, 0, 0),
  [173] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_token, 2, 0, 0),
  [175] = {.entry = {.count = 1, .reusable = true}}, SHIFT(5),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_token, 1, 0, 0),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__brace_balanced, 3, 0, 0),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_entry_repeat1, 2, 0, 6),
  [183] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_entry_repeat1, 2, 0, 6), SHIFT_REPEAT(67),
  ...
  [198] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_entry_repeat1, 2, 0, 4),
  ...
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field, 3, 0, 8),
...
TS_PUBLIC const TSLanguage *tree_sitter_bibtex(void) {
