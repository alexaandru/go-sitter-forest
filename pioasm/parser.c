...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__base_instruction, 2, 0, 2),
  [103] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__base_instruction, 2, 0, 2),
  [105] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__base_instruction, 3, 0, 2),
  [109] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__base_instruction, 3, 0, 2),
  ...
  [147] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_mov_target, 1, 0, 0),
  ...
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_wait_source, 2, 0, 0),
  [191] = {.entry = {.count = 1, .reusable = true}}, SHIFT(57),
  [193] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_wait_source, 2, 0, 0),
  [195] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_wait_source, 3, 0, 0),
  [197] = {.entry = {.count = 1, .reusable = true}}, SHIFT(60),
  [199] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_wait_source, 3, 0, 0),
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__blocking, 1, 0, 0),
  [203] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__blocking, 1, 0, 0),
  [205] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_mov_source, 1, 0, 0),
  [207] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_mov_source, 1, 0, 0),
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_mov_op, 1, 0, 0),
  [211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_directive, 2, 0, 1),
  ...
  [219] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_instruction, 2, 0, 3),
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_wait_source, 4, 0, 0),
  [223] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_wait_source, 4, 0, 0),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__base_instruction, 5, 0, 2),
  [227] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__base_instruction, 5, 0, 2),
  [229] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 1, 0, 0),
  [231] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_condition, 1, 0, 0),
  [233] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 2, 0, 0),
  [235] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_condition, 2, 0, 0),
  [237] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_symbol_def, 2, 0, 0),
  [239] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_symbol_def, 2, 0, 0),
  [241] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 3, 0, 0),
  [243] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_condition, 3, 0, 0),
  [245] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_delay, 3, 0, 0),
  [247] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_delay, 3, 0, 0),
  [249] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_symbol_def, 1, 0, 0),
  [251] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_symbol_def, 1, 0, 0),
  ...
  [265] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_set_target, 1, 0, 0),
  [267] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_set_target, 1, 0, 0),
  [269] = {.entry = {.count = 1, .reusable = true}}, SHIFT(95),
  [271] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_in_source, 1, 0, 0),
  [273] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_in_source, 1, 0, 0),
  [275] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_out_target, 1, 0, 0),
  [277] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_out_target, 1, 0, 0),
  [279] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sideset, 2, 0, 0),
  [281] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_optional, 1, 0, 0),
  ...
  [289] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_irq_modifiers, 1, 0, 0),
  [291] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_irq_modifiers, 1, 0, 0),
  [293] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_instruction, 3, 0, 3),
  [295] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_directive, 4, 0, 1),
  [297] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__line, 2, 0, 0),
  [299] = {.entry = {.count = 1, .reusable = true}}, SHIFT(103),
  [301] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_directive, 5, 0, 1),
  ...
  [319] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__lines, 1, 0, 0),
