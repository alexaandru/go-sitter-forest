...
static inline void advance_javascript(TSLexer *lexer) { lexer->advance_javascript(lexer, false); }

static inline void skip_javascript(TSLexer *lexer) { lexer->advance_javascript(lexer, true); }
