...
enum ts_symbol_identifiers {
  ...
  anon_sym_COLON = 101,
  sym_bound_apex_expression = 102,
  aux_sym_null_literal_token1 = 103,
  sym_string_literal = 104,
  sym_int = 105,
  sym_decimal = 106,
  sym_date = 107,
  sym_date_time = 108,
  sym_currency_literal = 109,
  sym_identifier = 110,
  sym_source_file = 111,
  sym_header_comment = 112,
  sym_formatting_comment = 113,
  sym__soql_query_expression = 114,
  sym_subquery = 115,
  sym_soql_query_body = 116,
  sym_count_expression = 117,
  sym_select_clause = 118,
  sym__selectable_expression = 119,
  sym_soql_using_clause = 120,
  sym_using_scope_type = 121,
  sym_type_of_clause = 122,
  sym_when_expression = 123,
  sym_else_expression = 124,
  sym_group_by_clause = 125,
  sym__group_by_expression = 126,
  sym_for_clause = 127,
  sym_for_type = 128,
  sym_having_clause = 129,
  sym_from_clause = 130,
  sym_storage_identifier = 131,
  sym_storage_alias = 132,
  sym_fields_expression = 133,
  sym_fields_type = 134,
  sym_where_clause = 135,
  sym__boolean_expression = 136,
  sym_and_expression = 137,
  sym_or_expression = 138,
  sym_not_expression = 139,
  sym__condition_expression = 140,
  sym_comparison_expression = 141,
  sym__comparison = 142,
  sym__value_comparison = 143,
  sym__set_comparison = 144,
  sym_comparable_list = 145,
  sym_soql_with_clause = 146,
  sym_soql_with_type = 147,
  sym_with_user_id_type = 148,
  sym_with_record_visibility_expression = 149,
  sym_with_record_visibility_param = 150,
  sym_with_data_cat_expression = 151,
  sym_with_data_cat_filter = 152,
  sym_with_data_cat_filter_type = 153,
  sym_limit_clause = 154,
  sym_offset_clause = 155,
  sym_update_clause = 156,
  sym_update_type = 157,
  sym_alias_expression = 158,
  sym_order_by_clause = 159,
  sym_order_expression = 160,
  sym_order_direction = 161,
  sym_order_null_direction = 162,
  sym_geo_location_type = 163,
  sym__value_expression = 164,
  sym_function_expression = 165,
  sym_dotted_identifier = 166,
  sym_field_identifier = 167,
  sym_field_list = 168,
  sym_boolean = 169,
  sym_value_comparison_operator = 170,
  sym_set_comparison_operator = 171,
  sym_date_literal = 172,
  sym_date_literal_with_param = 173,
  sym__function_name = 174,
  sym_null_literal = 175,
  sym__soql_literal = 176,
  aux_sym_source_file_repeat1 = 177,
  aux_sym_select_clause_repeat1 = 178,
  aux_sym_type_of_clause_repeat1 = 179,
  aux_sym__group_by_expression_repeat1 = 180,
  aux_sym_for_clause_repeat1 = 181,
  aux_sym_from_clause_repeat1 = 182,
  aux_sym_and_expression_repeat1 = 183,
  aux_sym_or_expression_repeat1 = 184,
  aux_sym_comparable_list_repeat1 = 185,
  aux_sym_with_record_visibility_expression_repeat1 = 186,
  aux_sym_with_data_cat_expression_repeat1 = 187,
  aux_sym_with_data_cat_filter_repeat1 = 188,
  aux_sym_update_clause_repeat1 = 189,
  aux_sym_order_by_clause_repeat1 = 190,
  aux_sym_function_expression_repeat1 = 191,
  aux_sym_dotted_identifier_repeat1 = 192,
  aux_sym_field_list_repeat1 = 193,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (('1' <= lookahead && lookahead <= '4')) ADVANCE(781);
    ...
    case 1:
      ...
      if (('1' <= lookahead && lookahead <= '4')) ADVANCE(779);
    ...
    case 632:
      ...
      END_STATE();
    case 633:
      if (('1' <= lookahead && lookahead <= '9')) ADVANCE(786);
      END_STATE();
    case 634:
